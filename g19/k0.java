...
public final class k0 implements Runnable	// class@0023c5
{
    public final l$b b;

    public void k0(l$b p0){
       this.b = p0;
    }
    public final void run(){
       ...
       if (PatchProxy.applyVoid(null, a, l.class, "17")) {
       }else {
          i3 oi3 = i3.f();
          oi3.d("head_position", "BOTTOM_BAR");
          User mVerifiedDet = a.S8().mVerifiedDetail;
