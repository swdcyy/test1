...
public final class b implements View$OnClickListener	// class@0002c6
{
    public final b b;
    ...
    public final void onClick(View p0){
       ...
       if (!PatchProxy.applyVoidOneRefs(liveStreamPa, obj, l0.class, "4")) {
          obj = new ClientEvent$ElementPackage();
          obj.action2 = "COMMENT_CANCEL_SUBCARD";
