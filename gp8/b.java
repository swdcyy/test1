...
public class b implements b	// class@0024b2
{
    ...
    public Object a(f p0){
       TKSwitch tKSwitch = PatchProxy.applyOneRefs(p0, this, b.class, "1");
       if (tKSwitch != PatchProxyResult.class) {
       }else {
          tKSwitch = new TKSwitch(p0);
       }
       return tKSwitch;
    }
    ...
    public Object e(Object p0,String p1){
       ...
       switch (i){
           ...
           case 4:
             return p0.style;
           case 5:
             return Boolean.valueOf(p0.checked);
           case 6:
    ...
    public String l(){
       return "nativeID,pivotPoint,enabled,style,onPress,disallowParentInterceptTouchEvent,onLongPress,checked,disable,getSize,layout,addAnimation,invokeNativeFunctionWithJSONString,getOrigin,observeNextLayout,setTranslateY,getLocationOnScreen,setRotateX,addEventListener,removeSelf,removeEventListener,resumeAnimations,setScaleY,removeAllAnimation,setScaleX,setRotateY,pauseAnimations,removeAnimation,setTranslateX,setVisibility,setBackgroundColor,setRotate,_setVNode,startViewAnimation,setGradientBgColor";
    }
}
