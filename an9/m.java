...
public final class m extends a	// class@00010e
{
    public b r;
    public p s;
    ...
    public void m(f$b p0,e p1,f p2,e p3,a p4,QPhoto p5){
       a.p(p5, "photo");
    ...
    public Map getObjectsByTag(String p0){
       Map obj = PatchProxy.applyOneRefs(p0, this, m.class, "5");
       if (obj != PatchProxyResult.class) {
          return obj;
       }
       obj = super.getObjectsByTag(p0);
       if (p0.equals("provider")) {
          obj.put(m.class, new s());
       }else {
