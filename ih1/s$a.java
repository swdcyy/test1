...
public final class s$a implements a	// class@0028f3
{
    public final s a;
    public final a b;

    public void s$a(s p0,a p1){
       this.a = p0;
       this.b = p1;
       super();
    }
    public void a(String p0,Object p1){
       if (PatchProxy.applyVoidTwoRefs(p0, p1, this, s$a.class, "1")) {
       }else {
          a.p(p0, "source");
          a.p(p1, "result");
          this.a.b = p1;
          ...
          if (uoa != null) {
             ...
             m.s(uoa.a()).p(q.b).F(r.b).n(uArrayList);
