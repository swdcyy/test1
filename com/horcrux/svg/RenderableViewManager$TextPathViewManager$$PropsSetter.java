package com.horcrux.svg.RenderableViewManager$TextPathViewManager$$PropsSetter;
...
public class RenderableViewManager$TextPathViewManager$$PropsSetter implements k$e	// class@0005e9
{

    public void RenderableViewManager$TextPathViewManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       ...
       p0.put("alignmentBaseline", "String");
       p0.put("backgroundColor", "Color");
       p0.put("baselineShift", "Dynamic");
       ...
       p0.put("inlineSize", "Dynamic");
       p0.put("lengthAdjust", "String");
       p0.put("markerEnd", "String");
       p0.put("markerMid", "String");
       p0.put("markerStart", "String");
       p0.put("mask", "String");
       p0.put("matrix", "Dynamic");
       p0.put("method", "String");
       p0.put("midLine", "String");
       p0.put("name", "String");
       ...
       p0.put("rotate", "Dynamic");
       p0.put("rotation", "number");
       p0.put("scaleX", "number");
       p0.put("scaleY", "number");
       p0.put("side", "String");
       p0.put("spacing", "String");
       p0.put("startOffset", "Dynamic");
    ...
    public void setProperty(RenderableViewManager$TextPathViewManager p0,VirtualView p1,String p2,Object p3){
       ...
       switch (p2.hashCode()){
           case 0x8810e443:
             if (p2.equals("spacing")) {
                i1 = 0;
             }
             break;
           case 0x8926c395:
             if (p2.equals("startOffset")) {
                i1 = 1;
             }
             break;
           case 0x995d38ca:
           ...
           case 0xb477f80b:
             ...
             break;
           case 0xba265948:
             if (p2.equals("alignmentBaseline")) {
                i1 = 6;
             }
             break;
           case 0xbc0e792f:
             if (p2.equals("verticalAlign")) {
                i1 = 7;
             }
             break;
           case 0xbf8d97c1:
    ...
    label_0392 :
       DynamicFromObject uDynamicFrom = 0x3f800000;
       float f = 0;
       switch (i1){
           case 0:
             p0.setSpacing(p1, p3);
             break;
           case 1:
             p0.setStartOffset(p1, new DynamicFromObject(p3));
             break;
           case 2:
             if (p3 != null) {
                f = p3.floatValue();
           ...
           case 3:
             ...
             break;
           case 4:
             p0.setLengthAdjust(p1, p3);
             break;
           case 5:
             if (p3 != null) {
                uDynamicFrom = p3.floatValue();
             }
             p0.setOpacity(p1, uDynamicFrom);
             break;
           case 6:
             p0.setMethod(p1, p3);
             break;
           case 7:
             p0.setVerticalAlign(p1, p3);
             break;
           case 8:
           ...
           case 12:
             ...
             break;
           case 13:
             p0.setRotate(p1, new DynamicFromObject(p3));
             break;
           case 14:
             if (p3 != null) {
                uDynamicFrom = p3.floatValue();
             }
             p0.setScaleX(p1, uDynamicFrom);
             break;
           case 15:
             if (p3 != null) {
                uDynamicFrom = p3.floatValue();
             }
             p0.setScaleY(p1, uDynamicFrom);
             break;
           case 16:
           ...
           case 21:
             ...
             p0.setStrokeOpacity(p1, uDynamicFrom);
             break;
           case 22:
           ...
           case 26:
             ...
             p0.setFillOpacity(p1, uDynamicFrom);
             break;
           case 27:
             if (p3 != null) {
                f = p3.floatValue();
             }
             p0.setStrokeDashoffset(p1, f);
             break;
           case 28:
             if (p3 != null) {
                f = p3.floatValue();
           ...
           case 31:
             ...
             break;
           case 32:
             p0.setDeltaX(p1, new DynamicFromObject(p3));
             break;
           case '!':
             p0.setDeltaY(p1, new DynamicFromObject(p3));
             break;
           case '"':
           ...
           case '(':
             ...
             break;
           case ')':
             float f1 = (p3 == null)? 4.00f: p3.floatValue();
             p0.setStrokeMiterlimit(p1, f1);
             break;
           case '*':
             if (p3 != null) {
                b = p3.intValue();
           ...
           case '+':
             ...
             break;
           case ',':
             p0.setBaselineShift(p1, new DynamicFromObject(p3));
             break;
           case '-':
           ...
           case '/':
             ...
             break;
           case '0':
             p0.setInlineSize(p1, new DynamicFromObject(p3));
             break;
           case '1':
           ...
           case ';':
             ...
             break;
           case '<':
             p0.setTextLength(p1, new DynamicFromObject(p3));
             break;
           case '=':
             p0.setDisplay(p1, p3);
             break;
