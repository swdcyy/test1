package com.horcrux.svg.RenderableViewManager$MarkerManager$$PropsSetter;
...
public class RenderableViewManager$MarkerManager$$PropsSetter implements k$e	// class@0005d5
{

    public void RenderableViewManager$MarkerManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       ...
       p0.put("markerHeight", "Dynamic");
       p0.put("markerMid", "String");
       p0.put("markerStart", "String");
       p0.put("markerUnits", "String");
       p0.put("markerWidth", "Dynamic");
       p0.put("mask", "String");
    ...
    public void setProperty(RenderableViewManager$MarkerManager p0,VirtualView p1,String p2,Object p3){
       ...
       switch (p2.hashCode()){
           ...
           case 0xcf0d448:
             ...
             break;
           case 0xd0a6755:
             if (p2.equals("markerUnits")) {
                i1 = 38;
             }
             break;
           case 0xd243dac:
             if (p2.equals("markerWidth")) {
                i1 = 39;
             }
             break;
           case 0xe557a7a:
    ...
    label_034c :
       ...
       switch (i1){
           ...
           case 30:
             ...
             break;
           case 31:
             p0.setRefX(p1, new DynamicFromObject(p3));
             break;
           case 32:
             p0.setRefY(p1, new DynamicFromObject(p3));
             break;
           case '!':
           ...
           case '%':
             ...
             break;
           case '&':
             p0.setMarkerUnits(p1, p3);
             break;
           case 39:
             p0.setMarkerWidth(p1, new DynamicFromObject(p3));
             break;
           case '(':
             if (p3 != null) {
                f1 = p3.floatValue();
           ...
           case ';':
             ...
             break;
           case '<':
             p0.setMarkerHeight(p1, new DynamicFromObject(p3));
             break;
           default:
       }
       return;
