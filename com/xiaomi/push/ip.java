...
public class ip implements is, Serializable, Cloneable	// class@001133
{
    public hw a;
    public String a;
    public List a;
    ...
    static {
       ip.g = new t6("XmPushActionUnSubscription");
       ip.h = new n6("", 11, 1);
       ip.i = new n6("", 12, 2);
       ip.j = new n6("", 11, 3);
       ip.k = new n6("", 11, 4);
    ...
    public String toString(){
       ip ta;
       String str1;
       StringBuilder str = "XmPushActionUnSubscription\(";
       int i = 0;
       if (this.a()) {
          str = str+"debug:";
          ta = this.a;
