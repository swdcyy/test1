...
public class hk implements is, Serializable, Cloneable	// class@001113
{
    public List a;
    ...
    public void a(){
       ...
       throw new je("Required field \'uploadDataItems\' was not present! Struct: "+this.toString());
    }
    public void a(hl p0){
       if (this.a == null) {
    ...
    public String toString(){
       StringBuilder str = "ClientUploadData\("+"uploadDataItems:";
       hk ta = this.a;
