...
public class io implements is, Serializable, Cloneable	// class@001132
{
    public long a;
    public hw a;
    public String a;
    ...
    static {
       io.f = new t6("XmPushActionUnRegistrationResult");
       io.g = new n6("", 11, 1);
       io.h = new n6("", 12, 2);
       io.i = new n6("", 11, 3);
       io.j = new n6("", 11, 4);
    ...
    public String toString(){
       io ta;
       String str1;
       StringBuilder str = "XmPushActionUnRegistrationResult\(";
       int i = 0;
       if (this.a()) {
          str = str+"debug:";
          ta = this.a;
