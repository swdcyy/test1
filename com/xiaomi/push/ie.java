...
public class ie implements is, Serializable, Cloneable	// class@001128
{
    public List a;
    ...
    static {
       ie.b = new t6("XmPushActionCustomConfig");
       ie.c = new n6("", 15, 1);
    }
    public void ie(){
       super();
    ...
    public void a(){
       ...
       throw new je("Required field \'customConfigs\' was not present! Struct: "+this.toString());
    }
    public void a(q6 p0){
       p0.k();
       n6 on6 = p0.g();
    ...
    public String toString(){
       StringBuilder str = "XmPushActionCustomConfig\("+"customConfigs:";
       ie ta = this.a;
