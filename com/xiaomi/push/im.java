...
public class im implements is, Serializable, Cloneable	// class@001130
{
    public long a;
    public hw a;
    public String a;
    ...
    static {
       im.h = new t6("XmPushActionSubscriptionResult");
       im.i = new n6("", 11, 1);
       im.j = new n6("", 12, 2);
       im.k = new n6("", 11, 3);
       im.l = new n6("", 11, 4);
    ...
    public String toString(){
       im ta;
       String str1;
       StringBuilder str = "XmPushActionSubscriptionResult\(";
       int i = 0;
       if (this.a()) {
          str = str+"debug:";
          ta = this.a;
