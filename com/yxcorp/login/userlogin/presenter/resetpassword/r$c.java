package com.yxcorp.login.userlogin.presenter.resetpassword.r$c;
...
public class r$c implements TextWatcher	// class@001bec
{
    public final r b;
    ...
    public void afterTextChanged(Editable p0){
       ...
       if (!PatchProxy.applyVoid(null, tb, r.class, "7")) {
          int i = 0;
          boolean b = (TextUtils.G(tb.s).length() > 0)? true: false;
          r t = tb.t;
          if (!b) {
             i = 8;
          }
