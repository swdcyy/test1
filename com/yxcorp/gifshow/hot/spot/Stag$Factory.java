package com.yxcorp.gifshow.hot.spot.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.hot.spot.model.StagFactoryksfeaturesftfeedhotspot;

public class Stag$Factory implements j	// class@00181a
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(HotSpotTrendingInfo.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(HotSpotTrendingInfo.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftfeedhotspot stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeaturesftfeedhotspot();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
