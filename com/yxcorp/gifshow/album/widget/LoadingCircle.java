package com.yxcorp.gifshow.album.widget.LoadingCircle;
...
import com.yxcorp.gifshow.album.widget.f;
...
public class LoadingCircle extends View	// class@001b07
{
    public final int b;
    public final int c;
    public final int d;
    ...
    static {
       LoadingCircle.x = Color.parseColor("#F2C7C7C7");
    }
    ...
    public final void a(){
       ...
       this.u.setColor(LoadingCircle.x);
    ...
    public final void b(){
       ...
       if (PatchProxy.applyVoid(objArray, this, LoadingCircle.class, "3")) {
          return;
       }
       int i = 2;
       ...
       valueAnimato.start();
       if (!PatchProxy.applyVoid(objArray, this, LoadingCircle.class, "4")) {
          ValueAnimator valueAnimato1 = ValueAnimator.ofInt(new int[i]{0,'Z'});
    ...
    public void onDraw(Canvas p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, LoadingCircle.class, "13")) {
          return;
       }
       if (this.v == null || (!PatchProxy.applyVoid(null, this, LoadingCircle.class, "2") && this.w == null)) {
          this.b();
          this.w = true;
       }
    label_0025 :
    ...
    public void onMeasure(int p0,int p1){
       if (PatchProxy.isSupport(LoadingCircle.class) && PatchProxy.applyVoidTwoRefs(Integer.valueOf(p0), Integer.valueOf(p1), this, LoadingCircle.class, "11")) {
          return;
       }
    ...
    public void setVisibility(int p0){
       if (PatchProxy.isSupport(LoadingCircle.class) && PatchProxy.applyVoidOneRefs(Integer.valueOf(p0), this, LoadingCircle.class, "12")) {
          return;
       }
