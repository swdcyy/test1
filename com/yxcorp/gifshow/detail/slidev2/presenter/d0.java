package com.yxcorp.gifshow.detail.slidev2.presenter.d0;
import com.smile.gifmaker.mvps.presenter.PresenterV2;
import com.yxcorp.gifshow.detail.slidev2.presenter.d0$a;
...
import com.yxcorp.gifshow.detail.slidev2.presenter.d0$c;
import android.view.View$OnClickListener;
import com.yxcorp.gifshow.recycler.fragment.BaseFragment;

public class d0 extends PresenterV2	// class@0018f8
{
    public final c A;
    public String p;
    ...
    public void E8(){
       ...
       this.X7(this.r.getUser().observable().subscribe(new f2(this)));
       this.u.P(this.t, this.z);
       this.v.a(this.A);
       this.X7(this.w.subscribe(new e2(this)));
       return;
    }
    public void J8(){
    ...
    public final boolean P8(){
       Object obj = PatchProxy.apply(null, this, d0.class, "12");
    ...
    public void R8(boolean p0){
       ...
       if (p0) {
          ...
          String obj = PatchProxy.apply(null, this, uod0, "9");
          if (obj != patchProxyRe) {
             patchProxyRe = obj.booleanValue();
          }else {
             obj = this.r.getUserId();
             Object obj1 = PatchProxy.applyOneRefs(obj, this, uod0, "11");
          ...
          if (patchProxyRe) {
             if (this.t.getParentFragment() == null) {
                ...
                this.q.g(true);
                this.q.a().setOnClickListener(new d0$c(this));
             }
          }else {
             this.q.g(false);
          }
