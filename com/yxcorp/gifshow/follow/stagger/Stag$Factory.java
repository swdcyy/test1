package com.yxcorp.gifshow.follow.stagger.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.follow.stagger.data.StagFactoryksfeaturesftfollowfollowstagger;
import com.yxcorp.gifshow.follow.stagger.config.StagFactoryksfeaturesftfollowfollowstagger;

public class Stag$Factory implements j	// class@001147
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (i) {
                ...
                j oj1 = this.d(FollowStaggerStartupPojo.class, obj, 0);
                if (oj1 != null) {
                   _monitor_exit(this);
                   oj = oj1;
                }
             }
             oj = this.d(FollowLiveSubscribeInfo.class, obj, typeAdapter1);
             if (oj != null) {
                _monitor_exit(this);
             }else {
                goto label_005e ;
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftfollowfollowstagger stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (p0) {
             if (p0 == 1) {
                stagFactoryk = new StagFactoryksfeaturesftfollowfollowstagger();
             }
          }else {
             stagFactoryk = new StagFactoryksfeaturesftfollowfollowstagger();
          }
