package com.yxcorp.gifshow.follow.common.widget.wave.WaveView;
...
import com.yxcorp.gifshow.follow.common.widget.wave.WaveView$Wave;
import ll8.c$b;
...
public final class WaveView extends View	// class@00108d
{
    public int b;
    public float c;
    public float d;
    ...
    public final void a(boolean p0){
       if (PatchProxy.isSupport(WaveView.class) && PatchProxy.applyVoidOneRefs(Boolean.valueOf(p0), this, WaveView.class, "2")) {
          return;
       }
       this.k.b = p0;
       return;
    ...
    public final void b(){
       ...
       if (PatchProxy.applyVoid(objArray, this, WaveView.class, "3")) {
          return;
       }
       WaveView tk = this.k;
       Objects.requireNonNull(tk);
       if (!PatchProxy.applyVoid(objArray, tk, WaveView$Wave.class, "4") && !tk.a().isRunning()) {
          tk.a().start();
       }
       return;
    }
    public final void c(){
       Object[] objArray = null;
       if (PatchProxy.applyVoid(objArray, this, WaveView.class, "4")) {
          return;
       }
       WaveView tk = this.k;
       Objects.requireNonNull(tk);
       if (!PatchProxy.applyVoid(objArray, tk, WaveView$Wave.class, "5") && tk.a().isRunning()) {
          tk.a().cancel();
       }
       return;
    }
    ...
    public final void setMaxWidth(float p0){
       this.e = p0;
    }
