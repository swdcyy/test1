package com.yxcorp.gifshow.follow.common.degrade.policy.WeightConfig;
...
public final class WeightConfig implements Serializable	// class@00104c
{
    public final FollowLevelWeightType type;
    public final double weight;

    public void WeightConfig(FollowLevelWeightType p0,double p1){
       super();
       this.type = p0;
       this.weight = p1;
    }
    public static WeightConfig copy$default(WeightConfig p0,FollowLevelWeightType p1,double p2,int p3,Object p4){
       WeightConfig type;
       WeightConfig weight;
       if (p3 & 0x01) {
          type = p0.type;
    ...
    public final WeightConfig copy(FollowLevelWeightType p0,double p1){
