package com.yxcorp.gifshow.follow.common.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.follow.common.model.StagFactoryksfeaturesftfollowfollowcommon;
import com.yxcorp.gifshow.follow.common.data.StagFactoryksfeaturesftfollowfollowcommon;

public class Stag$Factory implements j	// class@00100f
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (i) {
                ...
                j oj1 = this.d(LiveCoverAnnexResponse.class, obj, 0);
                if (oj1 != null) {
                   _monitor_exit(this);
                   oj = oj1;
                }
             }
             oj = this.d(RealtimeMeta$LogParams.class, obj, typeAdapter1);
             if (oj != null) {
                _monitor_exit(this);
             }else {
                goto label_005e ;
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftfollowfollowcommon stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (p0) {
             if (p0 == 1) {
                stagFactoryk = new StagFactoryksfeaturesftfollowfollowcommon();
             }
          }else {
             stagFactoryk = new StagFactoryksfeaturesftfollowfollowcommon();
          }
