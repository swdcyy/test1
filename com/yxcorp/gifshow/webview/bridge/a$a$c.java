package com.yxcorp.gifshow.webview.bridge.a$a$c;
import u07.u;
...
public class a$a$c implements u	// class@00170c
{
    public final a$a b;

    public void a$a$c(a$a p0){
       this.b = p0;
       super();
    }
    public void a(t p0,View p1){
       ...
       JsDialogParams$DialogButton mActions = this.b.k.get(2).mActions;
       if (mActions == null) {
          return;
       }
