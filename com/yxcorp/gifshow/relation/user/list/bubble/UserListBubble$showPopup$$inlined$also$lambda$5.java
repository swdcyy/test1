package com.yxcorp.gifshow.relation.user.list.bubble.UserListBubble$showPopup$$inlined$also$lambda$5;
import msd.l;
...
public final class UserListBubble$showPopup$$inlined$also$lambda$5 extends Lambda implements l	// class@001a1d
{
    ...
    public void UserListBubble$showPopup$$inlined$also$lambda$5(List p0,b p1,b p2,User p3,b p4,b p5,b p6,b p7,b p8,b p9,b p10,b p11,b p12,GifshowActivity p13,b p14,Ref$IntRef p15){
       int i = this;
       i.$items$inlined = p0;
    ...
    public final c invoke(View p0){
       Object obj = PatchProxy.applyOneRefsWithListener(p0, this, UserListBubble$showPopup$$inlined$also$lambda$5.class, "1");
       if (obj != PatchProxyResult.class) {
          return obj;
       }
       a.p(p0, "it");
       PatchProxy.onMethodExit(UserListBubble$showPopup$$inlined$also$lambda$5.class, "1");
       return UserListBubble.i(p0, this.$reportCallback$inlined);
    }
