package com.yxcorp.gifshow.label.tag.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.topic.StagFactorykscomponentslabeltag;

public class Stag$Factory implements j	// class@001a07
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(HomeLocalTopicConfig.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(HomeLocalTopicConfig.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentslabeltag stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactorykscomponentslabeltag();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
