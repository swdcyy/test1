package com.yxcorp.gifshow.qphotoplayer.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.detail.config.StagFactorykscomponentsqphotoplayer;

public class Stag$Factory implements j	// class@0016de
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(QPhotoPlayerStartupCommonPojo.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(QPhotoPlayerStartupCommonPojo.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentsqphotoplayer stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactorykscomponentsqphotoplayer();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
