package com.yxcorp.gifshow.prettify.v4.prettify.widget.PrettifySeekBar;
...
public class PrettifySeekBar extends RecordSeekBar	// class@0011db
{

    public void PrettifySeekBar(Context p0,AttributeSet p1){
       super(p0, p1);
       this.setProgressDrawable(this.e((float)a1.e(36.00f)));
    }
    public void PrettifySeekBar(Context p0,AttributeSet p1,int p2){
       super(p0, p1, p2);
       this.setProgressDrawable(this.e((float)a1.e(36.00f)));
    }
    public final Drawable e(float p0){
       RectF obj;
       if (PatchProxy.isSupport(PrettifySeekBar.class)) {
          obj = PatchProxy.applyOneRefs(Float.valueOf(p0), this, PrettifySeekBar.class, "1");
