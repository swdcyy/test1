package com.yxcorp.gifshow.v3.customizer.viewbinder.DefaultVideoFragmentV4ViewBinder;
import com.yxcorp.gifshow.v3.customizer.viewbinder.AbsVideoFragmentV3ViewBinder;
import com.yxcorp.gifshow.v3.customizer.viewbinder.DefaultVideoFragmentV4ViewBinder$a;
import nsd.u;
import c35.c;
...
import uoc.h;
import com.yxcorp.gifshow.v3.customizer.viewbinder.DefaultVideoFragmentV4ViewBinder$b;
...
public class DefaultVideoFragmentV4ViewBinder extends AbsVideoFragmentV3ViewBinder	// class@000d6a
{
    public RecyclerView H;
    public boolean I;
    public boolean J;
    public h K;
    public static final DefaultVideoFragmentV4ViewBinder$a L;

    static {
       DefaultVideoFragmentV4ViewBinder.L = new DefaultVideoFragmentV4ViewBinder$a(null);
    }
    public void DefaultVideoFragmentV4ViewBinder(c p0){
       a.p(p0, "viewHost");
       super(p0);
    }
    public void Q(){
       if (PatchProxy.applyVoid(null, this, DefaultVideoFragmentV4ViewBinder.class, "4")) {
          return;
       }
       super.Q();
       c uoc = this.G();
       ...
       if (activity != null) {
          DefaultVideoFragmentV4ViewBinder tK = this.K;
          if (tK == null) {
             a.S("viewAdjustHelper");
          }
          tK.a(activity, this.J);
       }
       return;
    }
    public void S(){
       if (PatchProxy.applyVoid(null, this, DefaultVideoFragmentV4ViewBinder.class, "5")) {
          return;
       }
       super.S();
       this.J = true;
       k1.o(new DefaultVideoFragmentV4ViewBinder$b(this));
       this.I = true;
       return;
    }
    public void s(View p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, DefaultVideoFragmentV4ViewBinder.class, "1")) {
          return;
       }
       a.p(p0, "rootView");
       ...
       view = m1.f(p0, R.id.playerBlack);
       a.o(view, "ViewBindUtils.bindWidget¡­otView, R.id.playerBlack\)");
       if (!PatchProxy.applyVoidOneRefs(view, this, AbsVideoFragmentV3ViewBinder.class, "12")) {
          a.p(view, "<set-?>");
          this.v = view;
       }
       h oh = new h(p0, this.G(), false, 4, null);
       this.K = view;
    ...
    public View u(LayoutInflater p0,ViewGroup p1,Bundle p2){
       View orWait;
       p2 = PatchProxy.applyThreeRefs(p0, p1, p2, this, DefaultVideoFragmentV4ViewBinder.class, "3");
       if (p2 != PatchProxyResult.class) {
          return p2;
       }
       a.p(p0, "inflater");
       if (PostExperimentUtils.H0()) {
          orWait = PreLoader.getInstance().getOrWait(p0.getContext(), R.layout.new_fragment_video_edit_preview_full_screen_v2, p1, false);
          a.m(orWait);
          a.o(orWait, "PreLoader.getInstance\(\).¡­n_v2, container, false\)!!");
       }else {
          orWait = a.c(p0, R.layout.new_fragment_video_edit_preview_full_screen_v2, p1, false);
          a.o(orWait, "inflater.inflate\(\n      ¡­een_v2, container, false\)");
       }
       return orWait;
    }
    public e y(EditorManager p0,Workspace$Type p1,Workspace$Source p2,EditorDelegate p3){
       Object obj = PatchProxy.applyFourRefs(p0, p1, p2, p3, this, DefaultVideoFragmentV4ViewBinder.class, "2");
