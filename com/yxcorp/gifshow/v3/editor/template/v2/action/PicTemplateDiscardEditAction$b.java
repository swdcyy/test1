package com.yxcorp.gifshow.v3.editor.template.v2.action.PicTemplateDiscardEditAction$b;
import erd.a;
...
public final class PicTemplateDiscardEditAction$b implements a	// class@00135f
{
    public final PicTemplateDiscardEditAction b;
    public final ViewModelProvider c;
    public final KSStore d;

    public void PicTemplateDiscardEditAction$b(PicTemplateDiscardEditAction p0,ViewModelProvider p1,KSStore p2){
       this.b = p0;
       this.c = p1;
       this.d = p2;
       super();
    ...
    public final void run(){
       if (PatchProxy.applyVoid(null, this, PicTemplateDiscardEditAction$b.class, "1")) {
          return;
       }
       a.a.d(this.c, true);
