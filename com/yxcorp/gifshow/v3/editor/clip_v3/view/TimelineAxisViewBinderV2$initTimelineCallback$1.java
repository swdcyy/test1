package com.yxcorp.gifshow.v3.editor.clip_v3.view.TimelineAxisViewBinderV2$initTimelineCallback$1;
import epc.a;
...
import xvc.b;
import opc.f;
import com.yxcorp.gifshow.v3.editor.clip_v3.view.TimelineAxisViewBinderV2$initTimelineCallback$1$onDragging$dragResult$1;
...
import com.yxcorp.gifshow.v3.editor.clip_v3.view.TimelineAxisViewBinderV2$initTimelineCallback$1$onDragStart$1;

public final class TimelineAxisViewBinderV2$initTimelineCallback$1 implements a	// class@000e1e
{
    public long a;
    public int b;
    public double c;
    public final TimelineAxisViewBinderV2 d;

    public void TimelineAxisViewBinderV2$initTimelineCallback$1(TimelineAxisViewBinderV2 p0){
       this.d = p0;
       super();
       this.b = -1;
    }
    public void a(int p0,a p1,boolean p2,float p3){
       ...
       if (PatchProxy.isSupport(TimelineAxisViewBinderV2$initTimelineCallback$1.class) && PatchProxy.applyVoidFourRefs(Integer.valueOf(p0), p1, Boolean.valueOf(p2), Float.valueOf(p3), this, TimelineAxisViewBinderV2$initTimelineCallback$1.class, "3")) {
          return;
       }
       a.p(p1, "segment");
       ...
       TimelineAxisViewBinderV2$initTimelineCallback$1 td = this.d;
       td.i = true;
       td.h = true;
    ...
    public void b(int p0,a p1,boolean p2,float p3){
       if (PatchProxy.isSupport(TimelineAxisViewBinderV2$initTimelineCallback$1.class) && PatchProxy.applyVoidFourRefs(Integer.valueOf(p0), p1, Boolean.valueOf(p2), Float.valueOf(p3), this, TimelineAxisViewBinderV2$initTimelineCallback$1.class, "2")) {
          return;
       }
       a.p(p1, "segment");
       double d = b.a(p3);
       TimelineAxisViewBinderV2$initTimelineCallback$1$onDragging$dragResult$1 oinitTimelin = new TimelineAxisViewBinderV2$initTimelineCallback$1$onDragging$dragResult$1(this, p0, p2, p3, d);
    ...
    public void c(int p0,a p1,boolean p2){
       if (PatchProxy.isSupport(TimelineAxisViewBinderV2$initTimelineCallback$1.class) && PatchProxy.applyVoidThreeRefs(Integer.valueOf(p0), p1, Boolean.valueOf(p2), this, TimelineAxisViewBinderV2$initTimelineCallback$1.class, "1")) {
          return;
       }
       a.p(p1, "segment");
       Object[] objArray = new Object[0];
       ...
       TimelineAxisViewBinderV2 c = this.d.c;
       SegmentDragStartAction segmentDragS = new SegmentDragStartAction(p0, p2, c.u0().e().e(), new TimelineAxisViewBinderV2$initTimelineCallback$1$onDragStart$1(this));
       c.t0(v6);
       return;
    }
}
