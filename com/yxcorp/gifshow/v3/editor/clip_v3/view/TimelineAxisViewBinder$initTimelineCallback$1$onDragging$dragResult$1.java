package com.yxcorp.gifshow.v3.editor.clip_v3.view.TimelineAxisViewBinder$initTimelineCallback$1$onDragging$dragResult$1;
import msd.l;
...
public final class TimelineAxisViewBinder$initTimelineCallback$1$onDragging$dragResult$1 extends Lambda implements l	// class@000e16
{
    public final float $deltaX;
    public final double $deltaXTime;
    public final int $index;
    public final boolean $isLeft;
    public final TimelineAxisViewBinder$initTimelineCallback$1 this$0;

    public void TimelineAxisViewBinder$initTimelineCallback$1$onDragging$dragResult$1(TimelineAxisViewBinder$initTimelineCallback$1 p0,int p1,boolean p2,float p3,double p4){
       this.this$0 = p0;
       this.$index = p1;
       this.$isLeft = p2;
       this.$deltaX = p3;
    ...
    public final void invoke(float p0){
       TimelineAxisViewBinder d;
       if (PatchProxy.isSupport(TimelineAxisViewBinder$initTimelineCallback$1$onDragging$dragResult$1.class) && PatchProxy.applyVoidOneRefs(Float.valueOf(p0), this, TimelineAxisViewBinder$initTimelineCallback$1$onDragging$dragResult$1.class, "1")) {
          return;
       }
       int i = 0;
