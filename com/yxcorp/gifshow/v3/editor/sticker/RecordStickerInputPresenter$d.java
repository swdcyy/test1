package com.yxcorp.gifshow.v3.editor.sticker.RecordStickerInputPresenter$d;
...
public final class RecordStickerInputPresenter$d implements ValueAnimator$AnimatorUpdateListener	// class@0011ff
{
    public final RecordStickerInputPresenter a;

    public void RecordStickerInputPresenter$d(RecordStickerInputPresenter p0){
       this.a = p0;
       super();
    }
    public final void onAnimationUpdate(ValueAnimator p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, RecordStickerInputPresenter$d.class, "1")) {
          return;
       }
       ...
       if (uEditDecorat != null) {
          ...
          uEditDecorat.setMoveY((p0.floatValue() / (float)this.a.P8().getHeight()));
       }
       RecordStickerInputPresenter$d ta = this.a;
       uEditDecorat = ta.V8();
