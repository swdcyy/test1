package com.yxcorp.gifshow.media.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.media.model.StagFactoryksfeatureapisvideoapi;

public class Stag$Factory implements j	// class@001cee
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(CameraUnitConfig.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(CameraUnitConfig.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeatureapisvideoapi stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeatureapisvideoapi();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
