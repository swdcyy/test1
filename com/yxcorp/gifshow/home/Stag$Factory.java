package com.yxcorp.gifshow.home.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.startup.StagFactoryksfeaturesftfeedkwaihome;

public class Stag$Factory implements j	// class@00163e
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(HomeStartupPojo.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(HomeStartupPojo.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftfeedkwaihome stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeaturesftfeedkwaihome();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
