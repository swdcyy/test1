package com.yxcorp.gifshow.featured.detail.featured.presenter.NasaLivePhotoDuplicatedPresenter$a;
import rda.b$a;
...
public final class NasaLivePhotoDuplicatedPresenter$a implements b$a	// class@000f65
{
          ...
          while (iterator.hasNext()) {
             ...
             if (!qPhoto.isLiveStream()) {
                ...
                if (i < 0) {
                   ...
                   if (e.e(qPhoto)) {
                      iterator.remove();
                      Log.d("NLPDP-FEATURE-GROOT", "not expired,deleted new£¬photo="+qPhoto);
                   }else if(NasaLivePhotoDuplicatedPresenter.P8(this.a).getCurrentPhoto() == qPhoto){
                      iterator.remove();
                      Log.d("NLPDP-FEATURE-GROOT", "expired,but is current,deleted new£¬photo="+qPhoto);
                   }else {
                      a.o(qPhoto, "cachePhoto");
                      obj.add(qPhoto);
                      Log.d("NLPDP-FEATURE-GROOT", "expired,deleted old£¬photo="+qPhoto);
                   }
                }
             }
          }
