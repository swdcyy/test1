package com.yxcorp.gifshow.emotion.editor.Stag$Factory;
import zk.j;
...
import com.yxcorp.plugin.emotion.config.StagFactorykscomponentsemotionfloateditor;

public class Stag$Factory implements j	// class@001bb0
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(EmotionEditorStartupCommonPojo.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(EmotionEditorStartupCommonPojo.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentsemotionfloateditor stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactorykscomponentsemotionfloateditor();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
