package com.yxcorp.gifshow.push.badge.impl.OPPOHomeBadger;
...
import com.yxcorp.gifshow.push.badge.impl.OPPOHomeBadger$executeBadgeByContentProvider$1;
import msd.a;

public final class OPPOHomeBadger extends BaseBadger	// class@00162f
{

    public void OPPOHomeBadger(){
       super();
    }
    public List a(){
    ...
    public final void f(Context p0,int p1){
       this.c(p0, new OPPOHomeBadger$executeBadgeByContentProvider$1(p1, p0));
    }
}
