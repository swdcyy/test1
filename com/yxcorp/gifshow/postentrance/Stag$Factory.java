package com.yxcorp.gifshow.postentrance.Stag$Factory;
import zk.j;
...
import a0c.i;
import com.yxcorp.gifshow.postentrance.util.StagFactoryksfeaturesftpostpostentrance;

public class Stag$Factory implements j	// class@001006
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(i.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(i.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftpostpostentrance stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeaturesftpostpostentrance();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
