package com.yxcorp.gifshow.resource.Stag$Factory;
import zk.j;
...
import com.kuaishou.android.model.response.StagFactorykscomponentsresource;

public class Stag$Factory implements j	// class@001b09
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(ConfigResponse.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(ConfigResponse.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentsresource stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactorykscomponentsresource();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
