package com.yxcorp.gifshow.albumwrapper.imagecrop.ImageSelectSupplier$ImageSelectType$3;
...
public final class ImageSelectSupplier$ImageSelectType$3 extends ImageSelectSupplier$ImageSelectType	// class@001b58
{

    public void ImageSelectSupplier$ImageSelectType$3(String p0,int p1,int p2){
       super(p0, p1, p2, null);
    }
    public Bundle getCropPrams(){
       Bundle obj = PatchProxy.apply(null, this, ImageSelectSupplier$ImageSelectType$3.class, "1");
       if (obj != PatchProxyResult.class) {
          return obj;
       }
       obj = new Bundle();
       obj.putString("crop", "true");
       obj.putInt("aspectX", 10);
       obj.putInt("aspectY", 11);
