package com.yxcorp.gifshow.matrix.dialog.focus.DialogPushTypeInterceptor$setToCleanDialog$1;
import msd.l;
...
public final class DialogPushTypeInterceptor$setToCleanDialog$1 extends Lambda implements l	// class@001ce4
{
    public final NotificationChain $chain;
    public final int $pushStyle;
    public final DialogPushTypeInterceptor this$0;

    public void DialogPushTypeInterceptor$setToCleanDialog$1(DialogPushTypeInterceptor p0,NotificationChain p1,int p2){
       this.this$0 = p0;
       this.$chain = p1;
       this.$pushStyle = p2;
       super(1);
    ...
    public final void invoke(boolean p0){
       if (PatchProxy.isSupport(DialogPushTypeInterceptor$setToCleanDialog$1.class) && PatchProxy.applyVoidOneRefs(Boolean.valueOf(p0), this, DialogPushTypeInterceptor$setToCleanDialog$1.class, "1")) {
          return;
       }
       if (!p0) {
