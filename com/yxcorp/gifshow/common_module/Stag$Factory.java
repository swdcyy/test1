package com.yxcorp.gifshow.common_module.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.corona.common.model.StagFactoryksfeaturesftcoronacoronacommon;

public class Stag$Factory implements j	// class@00117d
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(PadCoronaRankingListTabData.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(PadCoronaRankingListTabData.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftcoronacoronacommon stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeaturesftcoronacoronacommon();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
