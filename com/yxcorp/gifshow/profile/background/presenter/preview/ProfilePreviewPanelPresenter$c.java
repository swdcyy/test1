package com.yxcorp.gifshow.profile.background.presenter.preview.ProfilePreviewPanelPresenter$c;
...
public final class ProfilePreviewPanelPresenter$c extends m	// class@001276
{
    public final ProfilePreviewPanelPresenter c;

    public void ProfilePreviewPanelPresenter$c(ProfilePreviewPanelPresenter p0){
       this.c = p0;
       super();
    }
    public void a(View p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ProfilePreviewPanelPresenter$c.class, "1")) {
          return;
       }
       a.p(p0, "v");
       h oh = h.m("3398377", "CHOOSE_PICTURE_BUTTON");
       i3 oi3 = i3.f();
       oi3.c("name", Integer.valueOf(3));
       oh.n(oi3.e());
       ...
       if (t != null && t.getStatus() == 4) {
          ...
          this.c.W8(ImageSelectSupplier$Type.CAMERA);
          return;
       }
    }
}
