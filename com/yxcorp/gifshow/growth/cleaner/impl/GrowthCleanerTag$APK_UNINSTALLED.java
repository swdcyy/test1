package com.yxcorp.gifshow.growth.cleaner.impl.GrowthCleanerTag$APK_UNINSTALLED;
...
public final class GrowthCleanerTag$APK_UNINSTALLED extends GrowthCleanerTag	// class@001344
{
    ...
    public void GrowthCleanerTag$APK_UNINSTALLED(String p0,int p1){
       super(p0, p1, null);
       this.level = 2;
       this.showTag = GrowthCleanerHelper.c(0x7f1005a6);
       Application b = a.B;
       a.o(b, "AppEnv.APP");
