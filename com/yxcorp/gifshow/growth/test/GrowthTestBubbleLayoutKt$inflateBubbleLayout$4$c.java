package com.yxcorp.gifshow.growth.test.GrowthTestBubbleLayoutKt$inflateBubbleLayout$4$c;
...
public final class GrowthTestBubbleLayoutKt$inflateBubbleLayout$4$c implements GrowthTestLayout$Companion$a	// class@0014e9
{

    public void GrowthTestBubbleLayoutKt$inflateBubbleLayout$4$c(){
       super();
    }
    public void a(Object p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, GrowthTestBubbleLayoutKt$inflateBubbleLayout$4$c.class, "2")) {
       }else {
          k.b.c("KEY_K_BUBBLE_KRN_BUNDLE_PARAMS", p0);
       }
       return;
    }
    public Object b(){
       ...
       try{
          ...
          objArray1 = PatchProxy.apply(objArray, this, GrowthTestBubbleLayoutKt$inflateBubbleLayout$4$c.class, "1");
          if (objArray1 != PatchProxyResult.class) {
          }else {
             k b = k.b;
             String str1 = "KEY_K_BUBBLE_KRN_BUNDLE_PARAMS";
             if (!u.S1(str1)) {
                d uod = m0.d(str);
                boolean b1 = false;
