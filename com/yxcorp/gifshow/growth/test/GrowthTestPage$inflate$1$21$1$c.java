package com.yxcorp.gifshow.growth.test.GrowthTestPage$inflate$1$21$1$c;
...
public final class GrowthTestPage$inflate$1$21$1$c implements GrowthTestLayout$Companion$a	// class@00152a
{

    public void GrowthTestPage$inflate$1$21$1$c(){
       super();
    }
    public void a(Object p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, GrowthTestPage$inflate$1$21$1$c.class, "2")) {
       }else {
          k.b.c("KEY_EXPLORE_TAB_BUBBLE_SHOW_DURATION", p0);
       }
       return;
    }
    public Object b(){
       ...
       try{
          ...
          objArray1 = PatchProxy.apply(objArray, this, GrowthTestPage$inflate$1$21$1$c.class, "1");
          if (objArray1 != PatchProxyResult.class) {
          }else {
             k b = k.b;
             String str = "KEY_EXPLORE_TAB_BUBBLE_SHOW_DURATION";
             if (!u.S1(str)) {
