package com.yxcorp.gifshow.growth.test.GrowthTestBubbleLayoutKt$inflateBubbleLayout$4$b;
...
public final class GrowthTestBubbleLayoutKt$inflateBubbleLayout$4$b implements GrowthTestLayout$Companion$a	// class@0014e8
{

    public void GrowthTestBubbleLayoutKt$inflateBubbleLayout$4$b(){
       super();
    }
    public void a(Object p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, GrowthTestBubbleLayoutKt$inflateBubbleLayout$4$b.class, "2")) {
       }else {
          k.b.c("KEY_K_BUBBLE_KRN_COMPONENTNAME", p0);
       }
       return;
    }
    public Object b(){
       ...
       try{
          ...
          objArray1 = PatchProxy.apply(objArray, this, GrowthTestBubbleLayoutKt$inflateBubbleLayout$4$b.class, "1");
          if (objArray1 != PatchProxyResult.class) {
          }else {
             k b = k.b;
             String str1 = "KEY_K_BUBBLE_KRN_COMPONENTNAME";
             if (!u.S1(str1)) {
                d uod = m0.d(str);
                boolean b1 = false;
