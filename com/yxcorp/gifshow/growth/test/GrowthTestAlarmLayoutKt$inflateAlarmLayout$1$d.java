package com.yxcorp.gifshow.growth.test.GrowthTestAlarmLayoutKt$inflateAlarmLayout$1$d;
...
public final class GrowthTestAlarmLayoutKt$inflateAlarmLayout$1$d implements GrowthTestLayout$Companion$a	// class@0014d5
{
    public final GrowthTestAlarmLayoutKt$inflateAlarmLayout$1 b;

    public void GrowthTestAlarmLayoutKt$inflateAlarmLayout$1$d(GrowthTestAlarmLayoutKt$inflateAlarmLayout$1 p0){
       this.b = p0;
       super();
    }
    public void a(Object p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, GrowthTestAlarmLayoutKt$inflateAlarmLayout$1$d.class, "2")) {
       }else {
          k.b.c("KEY_ALARM_MINUTE", p0);
       }
       return;
    }
    public Object b(){
       ...
       try{
          ...
          integer = PatchProxy.apply(objArray, this, GrowthTestAlarmLayoutKt$inflateAlarmLayout$1$d.class, "1");
          if (integer != PatchProxyResult.class) {
          }else {
             k b = k.b;
             String str = "KEY_ALARM_MINUTE";
             Integer integer1 = Integer.valueOf(this.b.$DEFAULT_MINUTE);
             if (!u.S1(str)) {
