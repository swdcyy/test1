package com.yxcorp.gifshow.feed.activity.info.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.activity.info.StagFactorykscomponentsactivityinfo;

public class Stag$Factory implements j	// class@000fee
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(ActivityInfoStartupCommonPojo.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(ActivityInfoStartupCommonPojo.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentsactivityinfo stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactorykscomponentsactivityinfo();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
