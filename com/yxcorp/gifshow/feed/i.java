package com.yxcorp.gifshow.feed.i;
...
public class i implements a$b, d$b	// class@000ff8
{
    ...
    public void b(Context p0,CardStyle p1,PhotoItemViewParam p2,a p3,d$d p4){
       ...
       h.b(d.b(p0), p1, p2, p3, new z(this, p4, p2, p1));
       return;
    }
    public final f c(PhotoItemViewParam p0,View p1,CardStyle p2){
       PresenterV2 presenterV2;
       PatchProxyResult patchProxyRe = PatchProxyResult.class;
       f obj = PatchProxy.applyThreeRefs(p0, p1, p2, this, i.class, "5");
       if (obj != patchProxyRe) {
          return obj;
       }
       if (p0.mEnableLowDeviceHolderPresenterAsync != null) {
          obj = PatchProxy.applyThreeRefs(p0, p1, p2, null, y.class, "1");
          if (obj != patchProxyRe) {
          }else {
             presenterV2 = new PresenterV2();
             obj = new f();
             new e(p0).a(p0, p1, p2, Integer.valueOf(p0.mPage), PhotoType.VIDEO).c(presenterV2).b(obj).a(obj).f(obj).e(obj);
          ...
          obj = PatchProxy.applyThreeRefs(p0, p1, p2, null, x.class, "1");
          if (obj != patchProxyRe) {
          }else {
             presenterV2 = new PresenterV2();
             obj = new f();
             new e(p0).a(p0, p1, p2, Integer.valueOf(p0.mPage), PhotoType.VIDEO).c(presenterV2).b(obj).a(obj).f(obj).e(obj);
             f uof = new f(b.a(p1, p2, p0), presenterV2);
          ...
          f uof1 = new f();
          new e(p0).a(p0, p1, p2, Integer.valueOf(p0.mPage), PhotoType.VIDEO).c(uof1).b(uof1).a(uof1).f(uof1).e(uof1);
          return new f(b.a(p1, p2, p0), uof1);
       }
    }
}
