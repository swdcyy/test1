package com.yxcorp.gifshow.like.resource.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.loading.StagFactorykscomponentslikeresource;
import com.yxcorp.gifshow.like.resource.StagFactorykscomponentslikeresource;

public class Stag$Factory implements j	// class@001a5e
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (i) {
                ...
                j oj1 = this.d(LikeResourceStartupCommonPojo.class, obj, 0);
                if (oj1 != null) {
                   _monitor_exit(this);
                   oj = oj1;
                }
             }
             oj = this.d(PullDownResourceStartupCommonPojo.class, obj, typeAdapter1);
             if (oj != null) {
                _monitor_exit(this);
             }else {
                goto label_005e ;
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentslikeresource stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (p0) {
             if (p0 == 1) {
                stagFactoryk = new StagFactorykscomponentslikeresource();
             }
          }else {
             stagFactoryk = new StagFactorykscomponentslikeresource();
          }
