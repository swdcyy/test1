package com.yxcorp.gifshow.magic.core.Stag$Factory;
import zk.j;
...
import elb.f;
import com.yxcorp.gifshow.model.StagFactorykscomponentskwaimagicemojicore;

public class Stag$Factory implements j	// class@001b82
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(f.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(f.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentskwaimagicemojicore stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactorykscomponentskwaimagicemojicore();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
