package com.yxcorp.plugin.search.widget.OverScrollViewGroup;
import a2.w;
...
import com.yxcorp.plugin.search.widget.OverScrollViewGroup$a;
...
public final class OverScrollViewGroup extends FrameLayout implements w	// class@0007cf
{
    public boolean b;
    public boolean c;
    public boolean d;
    ...
    public final int a(View p0,float p1){
       if (PatchProxy.isSupport(OverScrollViewGroup.class)) {
          Object obj = PatchProxy.applyTwoRefs(p0, Float.valueOf(p1), this, OverScrollViewGroup.class, "17");
    ...
    public void d(View p0,int p1){
       if (PatchProxy.isSupport(OverScrollViewGroup.class) && PatchProxy.applyVoidTwoRefs(p0, Integer.valueOf(p1), this, OverScrollViewGroup.class, "18")) {
          return;
       }
    ...
    public final void e(View p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, OverScrollViewGroup.class, "10")) {
          return;
       }
       ...
       this.e.addUpdateListener(new g(this, p0, b));
    ...
    public void onNestedPreScroll(View p0,int p1,int p2,int[] p3){
       if (PatchProxy.isSupport(OverScrollViewGroup.class) && PatchProxy.applyVoidFourRefs(p0, Integer.valueOf(p1), Integer.valueOf(p2), p3, this, OverScrollViewGroup.class, "11")) {
          return;
       }
    ...
    public void onNestedScroll(View p0,int p1,int p2,int p3,int p4,int p5,int[] p6){
       ...
       if (PatchProxy.isSupport(OverScrollViewGroup.class)) {
          ...
          if (PatchProxy.applyVoid(objArray, this, OverScrollViewGroup.class, "15")) {
             return;
          }
       }
       ...
       if (p1 && (Math.abs(((float)p1 - p0.getTranslationX())) - (float)t0.f <= 0 && p5 == 1)) {
          p6[0] = 0;
       }
    label_00ac :
       return;
    ...
    public void onNestedScrollAccepted(View p0,View p1,int p2){
       if (PatchProxy.isSupport(OverScrollViewGroup.class) && PatchProxy.applyVoidThreeRefs(p0, p1, Integer.valueOf(p2), this, OverScrollViewGroup.class, "6")) {
          return;
       }
    ...
    public void onNestedScrollAccepted(View p0,View p1,int p2,int p3){
       if (PatchProxy.isSupport(OverScrollViewGroup.class) && PatchProxy.applyVoidFourRefs(p0, p1, Integer.valueOf(p2), Integer.valueOf(p3), this, OverScrollViewGroup.class, "7")) {
          return;
       }
    ...
    public boolean onStartNestedScroll(View p0,View p1,int p2,int p3){
       if (PatchProxy.isSupport(OverScrollViewGroup.class)) {
          p0 = PatchProxy.applyFourRefs(p0, p1, Integer.valueOf(p2), Integer.valueOf(p3), this, OverScrollViewGroup.class, "5");
          if (p0 != PatchProxyResult.class) {
             return p0.booleanValue();
          }
       }
       int i = 0;
       boolean b = (this.b != null || !p3)? true: false;
       this.b = b;
       b = (this.c != null || p3 == 1)? true: false;
       this.c = b;
       Object[] objArray = new Object[i];
       a.C().t("OverScrollViewGroup", "start scoll by nontouch : "+this.c, objArray);
       if (p2 & 0x01) {
          i = true;
       }
       return i;
    ...
    public void onStopNestedScroll(View p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, OverScrollViewGroup.class, "8")) {
          return;
       }
    ...
    public void onStopNestedScroll(View p0,int p1){
       if (PatchProxy.isSupport(OverScrollViewGroup.class) && PatchProxy.applyVoidTwoRefs(p0, Integer.valueOf(p1), this, OverScrollViewGroup.class, "9")) {
          return;
       }
       this.i.e(p0, p1);
       boolean b = false;
