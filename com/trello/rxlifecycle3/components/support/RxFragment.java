package com.trello.rxlifecycle3.components.support.RxFragment;
import gr8.a;
...
public abstract class RxFragment extends Fragment implements a	// class@000fea
{
    public final a b;

    public void RxFragment(){
       super();
       this.b = a.g();
    }
    public void RxFragment(int p0){
       super(p0);
       this.b = a.g();
    }
