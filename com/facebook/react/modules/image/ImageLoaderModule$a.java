package com.facebook.react.modules.image.ImageLoaderModule$a;
import kb.b;
...
public class ImageLoaderModule$a extends b	// class@0012bb
{
    public final Promise a;
    public final ImageLoaderModule b;

    public void ImageLoaderModule$a(ImageLoaderModule p0,Promise p1){
       this.b = p0;
       this.a = p1;
       super();
    }
    public void onFailureImpl(c p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ImageLoaderModule$a.class, "2")) {
          return;
       }
    ...
    public void onNewResultImpl(c p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ImageLoaderModule$a.class, "1")) {
          return;
       }
       if (!p0.a()) {
          return;
