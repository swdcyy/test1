package com.facebook.react.uimanager.RootViewManager$$PropsSetter;
...
public class RootViewManager$$PropsSetter implements k$e	// class@001327
{

    public void RootViewManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, RootViewManager$$PropsSetter.class, "2")) {
          return;
       }
    ...
    public void setProperty(ViewManager p0,View p1,String p2,Object p3){
       if (PatchProxy.applyVoidFourRefs(p0, p1, p2, p3, this, RootViewManager$$PropsSetter.class, "1")) {
       }else {
