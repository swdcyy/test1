package com.facebook.react.views.art.ARTShapeShadowNode$$PropsSetter;
...
public class ARTShapeShadowNode$$PropsSetter implements k$d	// class@00138f
{

    public void ARTShapeShadowNode$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ARTShapeShadowNode$$PropsSetter.class, "2")) {
          return;
       }
       p0.put("d", "Array");
       p0.put("fill", "Array");
    ...
    public void setProperty(x p0,String p1,Object p2){
       if (PatchProxy.applyVoidThreeRefs(p0, p1, p2, this, ARTShapeShadowNode$$PropsSetter.class, "1")) {
       }else {
