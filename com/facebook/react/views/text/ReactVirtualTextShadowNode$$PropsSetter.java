package com.facebook.react.views.text.ReactVirtualTextShadowNode$$PropsSetter;
...
public class ReactVirtualTextShadowNode$$PropsSetter implements k$d	// class@001414
{

    public void ReactVirtualTextShadowNode$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ReactVirtualTextShadowNode$$PropsSetter.class, "2")) {
          return;
       }
    ...
    public void setProperty(x p0,String p1,Object p2){
       ...
       if (PatchProxy.applyVoidThreeRefs(layoutShadow, p1, p2, this, ReactVirtualTextShadowNode$$PropsSetter.class, "1")) {
       }else {
