package com.facebook.react.views.text.ReactVirtualTextViewManager$$PropsSetter;
...
public class ReactVirtualTextViewManager$$PropsSetter implements k$e	// class@001416
{

    public void ReactVirtualTextViewManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ReactVirtualTextViewManager$$PropsSetter.class, "2")) {
          return;
       }
    ...
    public void setProperty(ViewManager p0,View p1,String p2,Object p3){
       if (PatchProxy.applyVoidFourRefs(p0, p1, p2, p3, this, ReactVirtualTextViewManager$$PropsSetter.class, "1")) {
       }else {
