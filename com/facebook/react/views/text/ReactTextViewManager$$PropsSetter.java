package com.facebook.react.views.text.ReactTextViewManager$$PropsSetter;
...
public class ReactTextViewManager$$PropsSetter implements k$e	// class@001411
{

    public void ReactTextViewManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ReactTextViewManager$$PropsSetter.class, "2")) {
          return;
       }
       ...
       p0.put("dataDetectorType", "String");
       p0.put("disabled", "boolean");
       p0.put("elevation", "number");
       p0.put("ellipsizeMode", "String");
       ...
       p0.put("onInlineViewLayout", "boolean");
    ...
    public void setProperty(ViewManager p0,View p1,String p2,Object p3){
       if (PatchProxy.applyVoidFourRefs(p0, p1, p2, p3, this, ReactTextViewManager$$PropsSetter.class, "1")) {
       }else {
          ...
          switch (p2.hashCode()){
              ...
              case 0xa96bf5bd:
                ...
                break;
              case 0xad55c822:
                if (p2.equals("adjustsFontSizeToFit")) {
                   i = 7;
                }
                break;
              case 0xb0bb87df:
              ...
              case 0xf2a62733:
                ...
                break;
              case 0xf7d659a7:
                if (p2.equals("onInlineViewLayout")) {
                   i = 20;
                }
                break;
              case 0xf9f0bcf5:
       ...
       label_02a0 :
          ...
          switch (i){
              ...
              case 7:
                ...
                p0.setAdjustFontSizeToFit(p1, b);
                break;
              case 8:
                i2 = (p3 == null)? Integer.MAX_VALUE: p3.intValue();
                p0.setNumberOfLines(p1, i2);
                break;
              case 9:
                if (p3 != null) {
                   integer = Integer.valueOf(p3.intValue());
              ...
              case 20:
                ...
                p0.setNotifyOnInlineViewLayout(p1, b);
                break;
              case 21:
