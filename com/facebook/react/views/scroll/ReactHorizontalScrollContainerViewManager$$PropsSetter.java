package com.facebook.react.views.scroll.ReactHorizontalScrollContainerViewManager$$PropsSetter;
...
public class ReactHorizontalScrollContainerViewManager$$PropsSetter implements k$e	// class@0013e1
{

    public void ReactHorizontalScrollContainerViewManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ReactHorizontalScrollContainerViewManager$$PropsSetter.class, "2")) {
          return;
       }
    ...
    public void setProperty(ViewManager p0,View p1,String p2,Object p3){
       if (PatchProxy.applyVoidFourRefs(p0, p1, p2, p3, this, ReactHorizontalScrollContainerViewManager$$PropsSetter.class, "1")) {
       }else {
