package com.facebook.react.views.textinput.ReactTextInputShadowNode$$PropsSetter;
...
public class ReactTextInputShadowNode$$PropsSetter implements k$d	// class@001430
{

    public void ReactTextInputShadowNode$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ReactTextInputShadowNode$$PropsSetter.class, "2")) {
          return;
       }
    ...
    public void setProperty(x p0,String p1,Object p2){
       ...
       if (PatchProxy.applyVoidThreeRefs(layoutShadow, p1, p2, this, ReactTextInputShadowNode$$PropsSetter.class, "1")) {
       }else {
          ...
          switch (i1){
              ...
              case '0':
                ...
                break;
              case '1':
                layoutShadow.setPlaceholder(obj);
                break;
              case '2':
              ...
              case '<':
                ...
                layoutShadow.setMostRecentEventCount(b);
                break;
              case '=':
                if (obj != null) {
                   f = obj.floatValue();
