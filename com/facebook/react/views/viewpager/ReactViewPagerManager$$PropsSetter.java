package com.facebook.react.views.viewpager.ReactViewPagerManager$$PropsSetter;
...
public class ReactViewPagerManager$$PropsSetter implements k$e	// class@001443
{

    public void ReactViewPagerManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ReactViewPagerManager$$PropsSetter.class, "2")) {
          return;
       }
       ...
       p0.put("pageMargin", "number");
       p0.put("peekEnabled", "boolean");
    ...
    public void setProperty(ViewManager p0,View p1,String p2,Object p3){
       if (PatchProxy.applyVoidFourRefs(p0, p1, p2, p3, this, ReactViewPagerManager$$PropsSetter.class, "1")) {
       }else {
