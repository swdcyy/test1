package com.facebook.react.views.picker.ReactDropdownPickerManager$$PropsSetter;
...
public class ReactDropdownPickerManager$$PropsSetter implements k$e	// class@0013d2
{

    public void ReactDropdownPickerManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ReactDropdownPickerManager$$PropsSetter.class, "2")) {
          return;
       }
    ...
    public void setProperty(ViewManager p0,View p1,String p2,Object p3){
       if (PatchProxy.applyVoidFourRefs(p0, p1, p2, p3, this, ReactDropdownPickerManager$$PropsSetter.class, "1")) {
       }else {
