package com.facebook.react.views.picker.ReactDropdownPickerManager;
import jf.g;
...
public class ReactDropdownPickerManager extends ReactPickerManager implements g	// class@0013d3
{
    public final c1 mDelegate;

    public void ReactDropdownPickerManager(){
       super();
    ...
    public ReactPicker createViewInstance(n0 p0){
       Object obj = PatchProxy.applyOneRefs(p0, this, ReactDropdownPickerManager.class, "1");
       if (obj != PatchProxyResult.class) {
          return obj;
       }
       return new ReactPicker(p0, 1);
    }
