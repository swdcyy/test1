package com.facebook.react.views.drawer.ReactDrawerLayoutManager$$PropsSetter;
...
public class ReactDrawerLayoutManager$$PropsSetter implements k$e	// class@0013b5
{

    public void ReactDrawerLayoutManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ReactDrawerLayoutManager$$PropsSetter.class, "2")) {
          return;
       }
       ...
       p0.put("drawerLockMode", "String");
       p0.put("drawerPosition", "Dynamic");
       p0.put("drawerWidth", "number");
    ...
    public void setProperty(ViewManager p0,View p1,String p2,Object p3){
       if (PatchProxy.applyVoidFourRefs(p0, p1, p2, p3, this, ReactDrawerLayoutManager$$PropsSetter.class, "1")) {
       }else {
          ...
          switch (p2.hashCode()){
              ...
              case 0x22936ee:
                ...
                break;
              case 0xffd3355:
                if (p2.equals("drawerWidth")) {
                   i = 13;
                }
                break;
              case 0x297a753a:
                if (p2.equals("drawerPosition")) {
                   i = 14;
                }
                break;
              case 0x2c861b47:
       ...
       label_015a :
          ...
          switch (i){
              ...
              case 12:
                ...
                break;
              case 13:
                f = (p3 == null)? Float.NaN: p3.floatValue();
                p0.setDrawerWidth(p1, f);
                break;
              case 14:
                p0.setDrawerPosition(p1, new DynamicFromObject(p3));
                break;
              case 15:
