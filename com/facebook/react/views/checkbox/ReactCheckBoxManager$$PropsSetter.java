package com.facebook.react.views.checkbox.ReactCheckBoxManager$$PropsSetter;
...
public class ReactCheckBoxManager$$PropsSetter implements k$e	// class@00139e
{

    public void ReactCheckBoxManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, ReactCheckBoxManager$$PropsSetter.class, "2")) {
          return;
       }
    ...
    public void setProperty(ViewManager p0,View p1,String p2,Object p3){
       if (PatchProxy.applyVoidFourRefs(p0, p1, p2, p3, this, ReactCheckBoxManager$$PropsSetter.class, "1")) {
       }else {
