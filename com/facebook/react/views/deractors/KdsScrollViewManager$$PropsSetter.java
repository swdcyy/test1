package com.facebook.react.views.deractors.KdsScrollViewManager$$PropsSetter;
...
import com.facebook.react.views.deractors.KdsScrollViewManager;
...
public class KdsScrollViewManager$$PropsSetter implements k$e	// class@0013af
{

    public void KdsScrollViewManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, KdsScrollViewManager$$PropsSetter.class, "2")) {
          return;
       }
    ...
    public void setProperty(ViewManager p0,View p1,String p2,Object p3){
       if (PatchProxy.applyVoidFourRefs(p0, p1, p2, p3, this, KdsScrollViewManager$$PropsSetter.class, "1")) {
       }else {
