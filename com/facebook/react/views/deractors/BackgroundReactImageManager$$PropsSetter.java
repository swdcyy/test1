package com.facebook.react.views.deractors.BackgroundReactImageManager$$PropsSetter;
...
public class BackgroundReactImageManager$$PropsSetter implements k$e	// class@0013a8
{

    public void BackgroundReactImageManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, BackgroundReactImageManager$$PropsSetter.class, "2")) {
          return;
       }
    ...
    public void setProperty(ViewManager p0,View p1,String p2,Object p3){
       if (PatchProxy.applyVoidFourRefs(p0, p1, p2, p3, this, BackgroundReactImageManager$$PropsSetter.class, "1")) {
       }else {
