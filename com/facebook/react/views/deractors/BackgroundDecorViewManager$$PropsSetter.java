package com.facebook.react.views.deractors.BackgroundDecorViewManager$$PropsSetter;
...
public class BackgroundDecorViewManager$$PropsSetter implements k$e	// class@0013a2
{

    public void BackgroundDecorViewManager$$PropsSetter(){
       super();
    }
    public void getProperties(Map p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, BackgroundDecorViewManager$$PropsSetter.class, "2")) {
          return;
       }
    ...
    public void setProperty(ViewManager p0,View p1,String p2,Object p3){
       ...
       if (PatchProxy.applyVoidFourRefs(reactViewMan, reactViewGro, p2, p3, this, BackgroundDecorViewManager$$PropsSetter.class, "1")) {
       }else {
