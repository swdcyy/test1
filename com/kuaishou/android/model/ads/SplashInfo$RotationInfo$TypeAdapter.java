package com.kuaishou.android.model.ads.SplashInfo$RotationInfo$TypeAdapter;
...
public final class SplashInfo$RotationInfo$TypeAdapter extends TypeAdapter	// class@000a97
{
    public final Gson a;
    ...
    static {
       SplashInfo$RotationInfo$TypeAdapter.c = a.get(SplashInfo$RotationInfo.class);
    }
    public void SplashInfo$RotationInfo$TypeAdapter(Gson p0){
       super();
       this.a = p0;
       this.b = p0.j(SplashInfo$AxisDirection$TypeAdapter.b);
    }
    public SplashInfo$RotationInfo a(a p0){
       JsonToken obj = PatchProxy.applyOneRefs(p0, this, SplashInfo$RotationInfo$TypeAdapter.class, "2");
       if (obj != PatchProxyResult.class) {
          return obj;
       }
       obj = p0.J();
       SplashInfo$RotationInfo rotationInfo = null;
       if (JsonToken.NULL == obj) {
          ...
          p0.c();
          SplashInfo$RotationInfo rotationInfo1 = new SplashInfo$RotationInfo();
          while (p0.l()) {
             String str = p0.y();
             ...
             switch (i){
                 case 0:
                   ...
                   break;
                 case 1:
                   rotationInfo1.mTriggerCount = KnownTypeAdapters$k.a(p0, rotationInfo1.mTriggerCount);
                   break;
                 case 2:
                   rotationInfo1.mImageUrl = TypeAdapters.A.read(p0);
                   break;
                 case 3:
                 ...
                 case 6:
                   ...
                   break;
                 case 7:
                   rotationInfo1.mClickDisabled = KnownTypeAdapters$g.a(p0, rotationInfo1.mClickDisabled);
                   break;
                 case 8:
                   rotationInfo1.mLiveTitle = TypeAdapters.A.read(p0);
                   break;
                 default:
                   p0.Q();
             }
    ...
    public void b(b p0,SplashInfo$RotationInfo p1){
       if (PatchProxy.applyVoidTwoRefs(p0, p1, this, SplashInfo$RotationInfo$TypeAdapter.class, "1")) {
          return;
       }
       if (p1 == null) {
          p0.u();
