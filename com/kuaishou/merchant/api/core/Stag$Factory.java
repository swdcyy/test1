package com.kuaishou.merchant.api.core.Stag$Factory;
import zk.j;
...
import com.kuaishou.merchant.api.core.model.StagFactoryksfeatureapismerchantapicoreapi;

public class Stag$Factory implements j	// class@00150a
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(CardCollectionFeedResponse.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(CardCollectionFeedResponse.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeatureapismerchantapicoreapi stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeatureapismerchantapicoreapi();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
