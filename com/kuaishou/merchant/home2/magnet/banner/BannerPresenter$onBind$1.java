package com.kuaishou.merchant.home2.magnet.banner.BannerPresenter$onBind$1;
import msd.l;
...
public final class BannerPresenter$onBind$1 extends FunctionReferenceImpl implements l	// class@0017ec
{

    public void BannerPresenter$onBind$1(BannerPresenter p0){
    ...
    public final void invoke(MerchantHomeSkin$ShowConfig p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, BannerPresenter$onBind$1.class, "1")) {
          return;
       }
       this.receiver.V8(p0);
       return;
