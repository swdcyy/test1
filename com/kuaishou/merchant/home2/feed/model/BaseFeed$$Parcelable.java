package com.kuaishou.merchant.home2.feed.model.BaseFeed$$Parcelable;
import android.os.Parcelable;
import xwd.d;
import com.kuaishou.merchant.home2.feed.model.BaseFeed$$Parcelable$a;
...
import com.kuaishou.merchant.home2.feed.model.BaseFeed$b;

public class BaseFeed$$Parcelable implements Parcelable, d	// class@001790
{
    ...
    public static BaseFeed read(Parcel p0,a p1){
       ...
       if (p1.a(i)) {
          ...
          BaseFeed uBaseFeed = new BaseFeed$b().c(p0);
          p1.f(i, uBaseFeed);
          return uBaseFeed;
       }
    }
