package com.kuaishou.merchant.krn.network.b;
import qi0.a;
...
public class b extends a	// class@00186d
{
    ...
    public List createKrnNativeModules(ReactApplicationContext p0){
       ...
       obj = new ArrayList();
       obj.add(ModuleSpec.nativeModuleSpec(MerchantNetWorkModule.class, new e(p0)));
       return obj;
    }
