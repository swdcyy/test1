package com.kuaishou.merchant.krn.popupmanager.a;
import qi0.a;
...
public class a extends a	// class@001871
{
    ...
    public List createKrnNativeModules(ReactApplicationContext p0){
       ...
       obj = new ArrayList();
       obj.add(ModuleSpec.nativeModuleSpec(PopupManagerBridge.class, new a(p0)));
       return obj;
    }
