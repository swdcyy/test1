package com.kuaishou.merchant.transaction.live.orderconfirmpanel.rnbridge.a;
import qi0.a;
...
public class a extends a	// class@00084d
{
    ...
    public List createKrnNativeModules(ReactApplicationContext p0){
       ...
       obj = new ArrayList();
       obj.add(ModuleSpec.nativeModuleSpec(MerchantCashierModule.class, new b(p0)));
       return obj;
    }
