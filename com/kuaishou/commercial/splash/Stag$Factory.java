package com.kuaishou.commercial.splash.Stag$Factory;
import zk.j;
...
import com.kuaishou.commercial.splash.record.StagFactoryksfeaturesftcommercialcommercialsplash;

public class Stag$Factory implements j	// class@00159d
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(SplashSummeryData.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(SplashSummeryData.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftcommercialcommercialsplash stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeaturesftcommercialcommercialsplash();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
