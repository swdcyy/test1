package com.kuaishou.ax2c.layouts.X2C_Nasa_Float_Controller;
...
public class X2C_Nasa_Float_Controller implements IViewCreator	// class@001119
{
    ...
    public View createView(Context p0){
       ...
       XmlAttrHostImpl xmlAttrHostI2;
       IAttrHost[] iAttrHostArr1;
       ...
       layoutParams.addRule(11, i);
       layoutParams.topMargin = c.b(resources, 0x7f070271);
       layoutParams.rightMargin = c.b(resources, 0x7f07034b);
       viewStub.setLayoutResource(R.layout.arg_RES_7f0d151b);
       viewStub.setLayoutParams(layoutParams);
       relativeLayo.addView(viewStub);
       int i3 = 0x7f110413;
       AttributeSet uAttributeSe = null;
       SlidePlaySeekBar slidePlaySee = new SlidePlaySeekBar(new ContextThemeWrapper(relativeLayo.getContext(), i3), uAttributeSe, 0);
