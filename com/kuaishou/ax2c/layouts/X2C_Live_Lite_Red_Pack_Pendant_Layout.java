package com.kuaishou.ax2c.layouts.X2C_Live_Lite_Red_Pack_Pendant_Layout;
...
public class X2C_Live_Lite_Red_Pack_Pendant_Layout implements IViewCreator	// class@0010fe
{

    public void X2C_Live_Lite_Red_Pack_Pendant_Layout(){
       super();
    }
    public View createView(Context p0){
       ...
       livePkShimme.setId(R.id.lite_red_pack_simmer_view);
       ...
       kwaiImageVie.setId(R.id.lite_red_pack_icon_image_view);
       ...
       uAppCompatTe.setId(R.id.lite_red_pack_content_text_view);
       layoutParams.gravity = 16;
       ...
       InputFilter[] inputFilterA = new InputFilter[]{new InputFilter$LengthFilter(3)};
       uAppCompatTe.setFilters(inputFilterA);
