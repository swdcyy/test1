package com.kuaishou.ax2c.layouts.X2C_Live_Lite_Comment_Item_Gift_Sent_Message_Layout;
...
public class X2C_Live_Lite_Comment_Item_Gift_Sent_Message_Layout implements IViewCreator	// class@0010eb
{

    public void X2C_Live_Lite_Comment_Item_Gift_Sent_Message_Layout(){
       super();
    }
    public View createView(Context p0){
       ...
       uEmojiTextVi.setId(R.id.live_lite_comment_item_common_text_view);
       uEmojiTextVi.setGravity(51);
       uEmojiTextVi.setBackgroundResource(R.drawable.arg_RES_7f081319);
       uEmojiTextVi.setTextSize(0, (float)c.b(resources, R.dimen.arg_RES_7f07080c));
