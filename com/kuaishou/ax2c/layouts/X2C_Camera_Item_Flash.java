package com.kuaishou.ax2c.layouts.X2C_Camera_Item_Flash;
...
public class X2C_Camera_Item_Flash implements IViewCreator	// class@001096
{
    ...
    public View createView(Context p0){
       ...
       uFlyWheelFra.setId(R.id.camera_flash_container);
       uFlyWheelFra.setTextViewId(R.id.button_photoflash);
       ...
       pressedDisab.setId(R.id.button_photoflash);
       pressedDisab.setText(R.string.arg_RES_7f10048d);
       pressedDisab.setImageHeight(c.b(resources, R.dimen.arg_RES_7f07012a));
       pressedDisab.setImageDrawable(R.drawable.arg_RES_7f08042e);
