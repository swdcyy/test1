package com.kuaishou.ax2c.layouts.X2C_Camera_Item_Assistant;
...
public class X2C_Camera_Item_Assistant implements IViewCreator	// class@001095
{
    ...
    public View createView(Context p0){
       ...
       pressedDisab.setId(R.id.assistant_side_bar_btn);
       pressedDisab.setBackgroundDrawable(null);
       pressedDisab.setClickable(true);
       pressedDisab.setText(R.string.arg_RES_7f10418e);
       pressedDisab.setImageDrawable(R.drawable.arg_RES_7f080f39);
