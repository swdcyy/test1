package com.kuaishou.ax2c.layouts.X2C_Count_Down_Icon_Layout;
...
public class X2C_Count_Down_Icon_Layout implements IViewCreator	// class@0010a1
{

    public void X2C_Count_Down_Icon_Layout(){
       super();
    }
    public View createView(Context p0){
       ...
       pressedDisab.setId(R.id.count_down_combinant);
       pressedDisab.setBackgroundDrawable(null);
       pressedDisab.setClickable(true);
       pressedDisab.setText(R.string.arg_RES_7f1008ee);
       pressedDisab.setImageHeight(c.b(resources, R.dimen.arg_RES_7f07012a));
       pressedDisab.setImageDrawable(R.drawable.arg_RES_7f08042a);
