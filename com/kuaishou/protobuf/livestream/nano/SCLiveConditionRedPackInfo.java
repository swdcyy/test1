package com.kuaishou.protobuf.livestream.nano.SCLiveConditionRedPackInfo;
...
public final class SCLiveConditionRedPackInfo extends MessageNano	// class@000d49
{
    ...
    public static SCLiveConditionRedPackInfo[] _emptyArray;

    public void SCLiveConditionRedPackInfo(){
       super();
       this.clear();
    }
    public static SCLiveConditionRedPackInfo[] emptyArray(){
       if (SCLiveConditionRedPackInfo._emptyArray == null) {
          Object lAZY_INIT_LO = InternalNano.LAZY_INIT_LOCK;
          _monitor_enter(lAZY_INIT_LO);
          if (SCLiveConditionRedPackInfo._emptyArray == null) {
             SCLiveConditionRedPackInfo[] sCLiveCondit = new SCLiveConditionRedPackInfo[0];
             SCLiveConditionRedPackInfo._emptyArray = sCLiveCondit;
          }
          _monitor_exit(lAZY_INIT_LO);
       }
       return SCLiveConditionRedPackInfo._emptyArray;
    }
    public static SCLiveConditionRedPackInfo parseFrom(CodedInputByteBufferNano p0){
       return new SCLiveConditionRedPackInfo().mergeFrom(p0);
    }
    public static SCLiveConditionRedPackInfo parseFrom(byte[] p0){
       return MessageNano.mergeFrom(new SCLiveConditionRedPackInfo(), p0);
    }
    ...
    public int computeSerializedSize(){
       ...
       SCLiveConditionRedPackInfo tredPackType = this.redPackType;
       ...
       SCLiveConditionRedPackInfo tlotteryTime = this.lotteryTime;
       if (tlotteryTime) {
       ...
       tredPackType = this.appendAllowMinDuration;
       if (tredPackType) {
          i = i + CodedOutputByteBufferNano.computeUInt64Size(12, tredPackType);
       }
       tredPackType = this.enableAppend;
       if (tredPackType != null) {
          i = i + CodedOutputByteBufferNano.computeBoolSize(13, tredPackType);
       }
       return i;
    }
    ...
    public SCLiveConditionRedPackInfo mergeFrom(CodedInputByteBufferNano p0){
       while (true) {
          int i = p0.readTag();
          switch (i){
              case 0:
              ...
              case 'Z':
                ...
                break;
              case '`':
                this.appendAllowMinDuration = p0.readUInt64();
                break;
              case 'h':
    ...
    public void writeTo(CodedOutputByteBufferNano p0){
       ...
       tredPackType = this.appendAllowMinDuration;
       if (tredPackType) {
          p0.writeUInt64(12, tredPackType);
       }
       tredPackType = this.enableAppend;
       if (tredPackType != null) {
          p0.writeBool(13, tredPackType);
       }
       super.writeTo(p0);
       return;
    }
