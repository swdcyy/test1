package com.kuaishou.live.audience.component.chat.single.BaseLiveAudienceSingleChatPresenter$g;
...
public final class BaseLiveAudienceSingleChatPresenter$g implements Runnable	// class@000a8a
{
    public final int b;
    public final String c;

    public void BaseLiveAudienceSingleChatPresenter$g(int p0,String p1){
       this.b = p0;
       this.c = p1;
       super();
    }
    public final void run(){
       if (PatchProxy.applyVoid(null, this, BaseLiveAudienceSingleChatPresenter$g.class, "1")) {
          return;
       }
       try{
          if (this.b == 1) {
