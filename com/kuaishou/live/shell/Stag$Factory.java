package com.kuaishou.live.shell.Stag$Factory;
import zk.j;
...
import com.kuaishou.live.common.course.model.StagFactoryksfeaturesftliveliveshell;
import com.kuaishou.live.common.core.basic.liveconfig.StagFactoryksfeaturesftliveliveshell;

public class Stag$Factory implements j	// class@000f8b
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (i) {
                ...
                j oj1 = this.d(LiveConfig.class, obj, 0);
                if (oj1 != null) {
                   _monitor_exit(this);
                   oj = oj1;
                }
             }
             oj = this.d(LiveCourseConfig.class, obj, typeAdapter1);
             if (oj != null) {
                _monitor_exit(this);
             }else {
                goto label_005e ;
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftliveliveshell stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (p0) {
             if (p0 == 1) {
                stagFactoryk = new StagFactoryksfeaturesftliveliveshell();
             }
          }else {
             stagFactoryk = new StagFactoryksfeaturesftliveliveshell();
          }
