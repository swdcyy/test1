package com.kuaishou.live.core.basic.widget.EllipsizeLayout;
...
public class EllipsizeLayout extends LinearLayout	// class@0008f7
{
    ...
    public void onMeasure(int p0,int p1){
       ...
       if (!this.getOrientation() && View$MeasureSpec.getMode(p0) == 0x40000000) {
          ...
          i4 = (View$MeasureSpec.getSize(p0) - this.getPaddingLeft()) - this.getPaddingRight();
          if (!(i1 | i4) && i3 > i4) {
