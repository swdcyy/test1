package com.kuaishou.live.core.voiceparty.micseats.pendant.KsCoinPendantViewController$viewModel$2;
import msd.a;
...
public final class KsCoinPendantViewController$viewModel$2 extends Lambda implements a	// class@00160f
{
    public final t $ksCoinInfoObservable;
    public final LiveData $micSeatId;
    public final f $micSeatStateService;

    public void KsCoinPendantViewController$viewModel$2(f p0,t p1,LiveData p2){
    ...
    public final KsCoinPendantViewModel invoke(){
       Object obj = PatchProxy.apply(null, this, KsCoinPendantViewController$viewModel$2.class, "1");
