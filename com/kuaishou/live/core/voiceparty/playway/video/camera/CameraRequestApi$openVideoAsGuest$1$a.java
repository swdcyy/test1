package com.kuaishou.live.core.voiceparty.playway.video.camera.CameraRequestApi$openVideoAsGuest$1$a;
import erd.g;
...
public final class CameraRequestApi$openVideoAsGuest$1$a implements g	// class@0018d5
{
    public final CameraRequestApi$openVideoAsGuest$1 b;

    public void CameraRequestApi$openVideoAsGuest$1$a(CameraRequestApi$openVideoAsGuest$1 p0){
       this.b = p0;
       super();
    }
    public void accept(Object p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, CameraRequestApi$openVideoAsGuest$1$a.class, "1")) {
       }else {
