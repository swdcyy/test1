package com.kuaishou.live.core.show.profilecard.photo.h$c;
import y8c.r;
...
import wb5.g;
import com.kuaishou.live.core.show.profilecard.photo.h$c$a;

public class h$c extends r	// class@000de6
{
    ...
    public void A(){
       ...
       roundingPara.n((float)a1.e(2.00f));
    ...
    public void z(){
       ...
       if (uBaseFeed == null) {
          ...
          try{
             ...
             if (this.r.w1(uBaseFeed)) {
                ...
                objArray1[objArray] = new c("FRAGMENT", this.r.z);
                uof.i(objArray1);
                this.m.setVisibility(8);
                this.q.setVisibility(8);
                this.l.setVisibility(8);
       ...
       label_0155 :
          ...
          if (ti.getTag(i) == uBaseFeed) {
             ...
             if (this.r.D != null) {
                this.i.setOnClickListener(new h$c$a(this, uBaseFeed));
             }
