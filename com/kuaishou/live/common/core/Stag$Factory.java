package com.kuaishou.live.common.core.Stag$Factory;
import zk.j;
...
import com.kuaishou.live.common.core.component.gift.domain.slot.config.displaysetup.StagFactoryksfeaturesftlivelivefeatureslivegift;

public class Stag$Factory implements j	// class@000e6d
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(LiveGiftDisplayConfig.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(LiveGiftDisplayConfig.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftlivelivefeatureslivegift stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeaturesftlivelivefeatureslivegift();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
