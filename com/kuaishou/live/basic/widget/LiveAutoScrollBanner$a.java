package com.kuaishou.live.basic.widget.LiveAutoScrollBanner$a;
import lnc.cb;
...
public class LiveAutoScrollBanner$a extends cb	// class@000d2e
{
    ...
    public void a(){
       ...
       if (liveAutoScro != null) {
          Object obj = PatchProxy.apply(objArray, liveAutoScro, LiveAutoScrollBanner.class, "11");
          ...
          if (b) {
             if (!PatchProxy.applyVoid(objArray, liveAutoScro, LiveAutoScrollBanner.class, "10") && (liveAutoScro.g.getAdapter() != null && liveAutoScro.g.getAdapter().getItemCount() > 0)) {
