package com.kuaishou.live.lite.framework.loader.LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$4;
import msd.a;
...
import com.kuaishou.live.lite.framework.loader.LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$4$$special$$inlined$trace$lambda$1;
import ec3.f;
...
public final class LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$4 extends Lambda implements a	// class@000942
{
    ...
    public void LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$4(LiveLitePresenterScatterLoader p0,Activity p1,e p2,LiveLiteModelManager p3,c p4){
       this.this$0 = p0;
       this.$activity = p1;
    ...
    public final void invoke(){
       ...
       String str1 = "%s - %.3fms";
       if (PatchProxy.applyVoid(null, this, LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$4.class, "1")) {
          return;
       }
       String str2 = this.this$0.g()+"FactoryList.addInjectTaskFirstPhase";
       ...
       while (iterator.hasNext()) {
          ...
          if (uob.b().compareTo(LiveLiteAdapterPlugin$ScatterPriority.Default) < 0) {
             ...
             this.this$0.x(StringsKt__StringsKt.Z3(StringsKt__StringsKt.T3(simpleName, "LiveLite"), "Presenter")+"::InjectService", new LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$4$$special$$inlined$trace$lambda$1(uob, this));
          }
       }
       a = l1.a;
       Trace.endSection();
