package com.kuaishou.live.lite.framework.loader.LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$3;
import msd.a;
...
import com.kuaishou.live.lite.framework.loader.LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$3$$special$$inlined$trace$lambda$1;
import ec3.f;
...
public final class LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$3 extends Lambda implements a	// class@000940
{
    ...
    public void LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$3(LiveLitePresenterScatterLoader p0,Activity p1,e p2,LiveLiteModelManager p3,c p4){
       this.this$0 = p0;
       this.$activity = p1;
    ...
    public final void invoke(){
       ...
       String str1 = "%s - %.3fms";
       if (PatchProxy.applyVoid(null, this, LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$3.class, "1")) {
          return;
       }
       String str2 = this.this$0.g()+"FactoryList.addRegisterTask";
       ...
       while (iterator.hasNext()) {
          ...
          this.this$0.x(StringsKt__StringsKt.Z3(StringsKt__StringsKt.T3(simpleName, "LiveLite"), "Presenter")+"::Register", new LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$3$$special$$inlined$trace$lambda$1(uob, this));
       }
       a = l1.a;
       Trace.endSection();
