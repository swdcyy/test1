package com.kuaishou.live.lite.framework.loader.LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$2;
import msd.a;
...
import com.kuaishou.live.lite.framework.loader.LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$2$$special$$inlined$trace$lambda$1;
import ec3.f;
...
public final class LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$2 extends Lambda implements a	// class@00093e
{
    ...
    public void LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$2(LiveLitePresenterScatterLoader p0,Activity p1,e p2,LiveLiteModelManager p3,c p4){
       this.this$0 = p0;
       this.$activity = p1;
    ...
    public final void invoke(){
       ...
       String str1 = "%s - %.3fms";
       if (PatchProxy.applyVoid(null, this, LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$2.class, "1")) {
          return;
       }
       ...
       while (iterator.hasNext()) {
          ...
          this.this$0.x(StringsKt__StringsKt.Z3(StringsKt__StringsKt.T3(simpleName, "LiveLite"), "Presenter")+"::InjectModel", new LiveLitePresenterScatterLoader$scheduleSlidingLoadTasks$2$$special$$inlined$trace$lambda$1(uob, this));
       }
       a = l1.a;
       Trace.endSection();
