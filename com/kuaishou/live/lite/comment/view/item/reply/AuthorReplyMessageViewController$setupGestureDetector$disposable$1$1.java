package com.kuaishou.live.lite.comment.view.item.reply.AuthorReplyMessageViewController$setupGestureDetector$disposable$1$1;
import msd.l;
...
public final class AuthorReplyMessageViewController$setupGestureDetector$disposable$1$1 extends Lambda implements l	// class@00083b
{
    public final AuthorReplyMessageViewController$setupGestureDetector$disposable$1 this$0;

    public void AuthorReplyMessageViewController$setupGestureDetector$disposable$1$1(AuthorReplyMessageViewController$setupGestureDetector$disposable$1 p0){
       this.this$0 = p0;
       super(1);
    }
    ...
    public final boolean invoke(MotionEvent p0){
       ...
       EmojiTextView obj = PatchProxy.applyOneRefs(p0, this, AuthorReplyMessageViewController$setupGestureDetector$disposable$1$1.class, "1");
       if (obj != PatchProxyResult.class) {
          return obj.booleanValue();
       }
       a.p(p0, "it");
       obj = AuthorReplyMessageViewController.Y2(this.this$0.this$0);
       int i = 0;
       ...
       if (i ^ 0x01) {
          ArraysKt___ArraysKt.ob(uClickableSp).onClick(AuthorReplyMessageViewController.Y2(this.this$0.this$0));
       }
       return true;
    }
}
