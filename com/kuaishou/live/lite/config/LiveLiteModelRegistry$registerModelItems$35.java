package com.kuaishou.live.lite.config.LiveLiteModelRegistry$registerModelItems$35;
import msd.l;
...
public final class LiveLiteModelRegistry$registerModelItems$35 extends Lambda implements l	// class@000892
{
    public final e0 $logPage;
    public final LiveLiteParam $param;

    public void LiveLiteModelRegistry$registerModelItems$35(LiveLiteParam p0,e0 p1){
       this.$param = p0;
       this.$logPage = p1;
       super(1);
    }
    ...
    public final f invoke(LiveLiteModelManager p0){
       Object obj = PatchProxy.applyOneRefs(p0, this, LiveLiteModelRegistry$registerModelItems$35.class, "1");
