package com.kuaishou.live.playback.Stag$Factory;
import zk.j;
...
import com.kuaishou.live.playback.playmodule.log.StagFactoryksfeaturesftliveliveexternalliveplayback;

public class Stag$Factory implements j	// class@000d1f
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(LivePlaybackPhotoLogger.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(LivePlaybackPhotoLogger.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftliveliveexternalliveplayback stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeaturesftliveliveexternalliveplayback();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
