package com.kuaishou.growth.taskcenter.Stag$Factory;
import zk.j;
...
import com.kuaishou.growth.taskcenter.model.StagFactoryksfeaturesftgrowthtaskcenter;

public class Stag$Factory implements j	// class@000726
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(TaskPendantCommonParams.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(TaskPendantCommonParams.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftgrowthtaskcenter stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeaturesftgrowthtaskcenter();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
