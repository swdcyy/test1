package com.kuaishou.growth.pendant.realtime.price.Stag$Factory;
import zk.j;
...
import we0.n;
import af0.a;
import com.kuaishou.growth.pendant.realtime.price.store.StagFactoryksfeaturesftgrowthpendantrealtimeprice;
import com.kuaishou.growth.pendant.realtime.price.core.StagFactoryksfeaturesftgrowthpendantrealtimeprice;
import com.kuaishou.growth.pendant.realtime.price.speed.StagFactoryksfeaturesftgrowthpendantrealtimeprice;

public class Stag$Factory implements j	// class@000696
{
          ...
          if (integer != null) {
             ...
             if (i) {
                if (i != 1) {
                   ...
                   label_0061 :
                      oj = this.d(a.class, obj, typeAdapter1);
                      if (oj != null) {
                         _monitor_exit(this);
                      }else {
                         goto label_006b ;
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftgrowthpendantrealtimeprice stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (p0) {
             if (p0 != 1) {
                if (p0 == 2) {
                   stagFactoryk = new StagFactoryksfeaturesftgrowthpendantrealtimeprice();
                }
             }else {
                stagFactoryk = new StagFactoryksfeaturesftgrowthpendantrealtimeprice();
             }
