package com.kuaishou.growth.pendant.core.Stag$Factory;
import zk.j;
...
import com.kuaishou.growth.pendant.core.response.StagFactoryksfeaturesftgrowthpendantcore;

public class Stag$Factory implements j	// class@000631
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(PendantCommonParams.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(PendantCommonParams.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftgrowthpendantcore stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeaturesftgrowthpendantcore();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
