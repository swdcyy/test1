package com.kuaishou.client.log.content.packages.nano.ClientContentWrapper$LiveVoicePartyPackage;
...
public final class ClientContentWrapper$LiveVoicePartyPackage extends MessageNano	// class@001332
{
    ...
    public static ClientContentWrapper$LiveVoicePartyPackage[] _emptyArray;

    public void ClientContentWrapper$LiveVoicePartyPackage(){
       super();
       this.clear();
    }
    public static ClientContentWrapper$LiveVoicePartyPackage[] emptyArray(){
       if (ClientContentWrapper$LiveVoicePartyPackage._emptyArray == null) {
          Object lAZY_INIT_LO = InternalNano.LAZY_INIT_LOCK;
          _monitor_enter(lAZY_INIT_LO);
          if (ClientContentWrapper$LiveVoicePartyPackage._emptyArray == null) {
             ClientContentWrapper$LiveVoicePartyPackage[] liveVoicePar = new ClientContentWrapper$LiveVoicePartyPackage[0];
             ClientContentWrapper$LiveVoicePartyPackage._emptyArray = liveVoicePar;
          }
          _monitor_exit(lAZY_INIT_LO);
       }
       return ClientContentWrapper$LiveVoicePartyPackage._emptyArray;
    }
    public static ClientContentWrapper$LiveVoicePartyPackage parseFrom(CodedInputByteBufferNano p0){
       return new ClientContentWrapper$LiveVoicePartyPackage().mergeFrom(p0);
    }
    public static ClientContentWrapper$LiveVoicePartyPackage parseFrom(byte[] p0){
       return MessageNano.mergeFrom(new ClientContentWrapper$LiveVoicePartyPackage(), p0);
    }
    public ClientContentWrapper$LiveVoicePartyPackage clear(){
       this.voicePartyId = "";
       this.role = 0;
       this.guestNumber = 0;
    ...
    public int computeSerializedSize(){
       ...
       ClientContentWrapper$LiveVoicePartyPackage trole = this.role;
       if (trole != null) {
       ...
       ClientContentWrapper$LiveVoicePartyPackage tenterVoiceP = this.enterVoicePartyTimestamp;
       if (tenterVoiceP) {
    ...
    public ClientContentWrapper$LiveVoicePartyPackage mergeFrom(CodedInputByteBufferNano p0){
       while (true) {
          int i = p0.readTag();
          int i1 = 3;
          switch (i){
