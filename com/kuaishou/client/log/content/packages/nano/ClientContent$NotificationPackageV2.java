package com.kuaishou.client.log.content.packages.nano.ClientContent$NotificationPackageV2;
...
public final class ClientContent$NotificationPackageV2 extends MessageNano	// class@0012bb
{
    ...
    public float value;
    public static ClientContent$NotificationPackageV2[] _emptyArray;

    public void ClientContent$NotificationPackageV2(){
       super();
       this.clear();
    }
    public static ClientContent$NotificationPackageV2[] emptyArray(){
       if (ClientContent$NotificationPackageV2._emptyArray == null) {
          Object lAZY_INIT_LO = InternalNano.LAZY_INIT_LOCK;
          _monitor_enter(lAZY_INIT_LO);
          if (ClientContent$NotificationPackageV2._emptyArray == null) {
             ClientContent$NotificationPackageV2[] notification = new ClientContent$NotificationPackageV2[0];
             ClientContent$NotificationPackageV2._emptyArray = notification;
          }
          _monitor_exit(lAZY_INIT_LO);
       }
       return ClientContent$NotificationPackageV2._emptyArray;
    }
    public static ClientContent$NotificationPackageV2 parseFrom(CodedInputByteBufferNano p0){
       return new ClientContent$NotificationPackageV2().mergeFrom(p0);
    }
    public static ClientContent$NotificationPackageV2 parseFrom(byte[] p0){
       return MessageNano.mergeFrom(new ClientContent$NotificationPackageV2(), p0);
    }
    public ClientContent$NotificationPackageV2 clear(){
       this.notifyId = "";
       this.type = "";
       this.aggregate = "";
       this.unread = "";
    ...
    public int computeSerializedSize(){
       ...
       ClientContent$NotificationPackageV2 tindex = this.index;
       if (tindex != null) {
    ...
    public ClientContent$NotificationPackageV2 mergeFrom(CodedInputByteBufferNano p0){
       while (true) {
          int i = p0.readTag();
          switch (i){
              case 0:
