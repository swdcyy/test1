package com.kuaishou.client.log.event.packages.nano.ClientEvent$TaskEvent;
...
public final class ClientEvent$TaskEvent extends MessageNano	// class@000772
{
    public int action;
    ...
    public static ClientEvent$TaskEvent[] _emptyArray;

    public void ClientEvent$TaskEvent(){
       super();
       this.clear();
    }
    public static ClientEvent$TaskEvent[] emptyArray(){
       if (ClientEvent$TaskEvent._emptyArray == null) {
          Object lAZY_INIT_LO = InternalNano.LAZY_INIT_LOCK;
          _monitor_enter(lAZY_INIT_LO);
          if (ClientEvent$TaskEvent._emptyArray == null) {
             ClientEvent$TaskEvent[] taskEventArr = new ClientEvent$TaskEvent[0];
             ClientEvent$TaskEvent._emptyArray = taskEventArr;
          }
          _monitor_exit(lAZY_INIT_LO);
       }
       return ClientEvent$TaskEvent._emptyArray;
    }
    public static ClientEvent$TaskEvent parseFrom(CodedInputByteBufferNano p0){
       return new ClientEvent$TaskEvent().mergeFrom(p0);
    }
    public static ClientEvent$TaskEvent parseFrom(byte[] p0){
       return MessageNano.mergeFrom(new ClientEvent$TaskEvent(), p0);
    }
    public ClientEvent$TaskEvent clear(){
       this.sessionId = "";
       this.action = 0;
       this.action2 = "";
       this.status = 0;
    ...
    public int computeSerializedSize(){
       ...
       ClientEvent$TaskEvent taction = this.action;
       if (taction != null) {
          i = i + CodedOutputByteBufferNano.computeInt32Size(2, taction);
       }
       taction = this.status;
       if (taction != null) {
          i = i + CodedOutputByteBufferNano.computeInt32Size(3, taction);
       }
       taction = this.urlPackage;
       if (taction != null) {
          i = i + CodedOutputByteBufferNano.computeMessageSize(4, taction);
       }
       taction = this.elementPackage;
       if (taction != null) {
          i = i + CodedOutputByteBufferNano.computeMessageSize(5, taction);
       }
       taction = this.trigger;
       if (taction != null) {
          i = i + CodedOutputByteBufferNano.computeInt32Size(6, taction);
       }
       taction = this.resultPackage;
       if (taction != null) {
          i = i + CodedOutputByteBufferNano.computeMessageSize(7, taction);
       }
       taction = this.contentPackage;
       if (taction != null) {
          i = i + CodedOutputByteBufferNano.computeMessageSize(8, taction);
       }
       taction = this.taskDetailPackage;
       if (taction != null) {
       ...
       if (taction != null) {
          i = i + CodedOutputByteBufferNano.computeMessageSize(11, taction);
       }
       if (Float.floatToIntBits(this.ratio) != Float.floatToIntBits(0)) {
          i = i + CodedOutputByteBufferNano.computeFloatSize(12, this.ratio);
       }
       if (!(this.contentWrapper).equals(str)) {
          i = i + CodedOutputByteBufferNano.computeStringSize(13, this.contentWrapper);
       }
       if (!(this.action2).equals(str)) {
          i = i + CodedOutputByteBufferNano.computeStringSize(14, this.action2);
       }
       taction = this.areaPackage;
       if (taction != null) {
          i = i + CodedOutputByteBufferNano.computeMessageSize(15, taction);
       }
       ...
       if (!(this.internalStidContainerJson).equals(str)) {
          i = i + CodedOutputByteBufferNano.computeStringSize(17, this.internalStidContainerJson);
       }
       taction = this.interStidContainer;
       if (taction != null) {
          i = i + CodedOutputByteBufferNano.computeMessageSize(18, taction);
       }
       if (!(this.interStExParams).equals(str)) {
          i = i + CodedOutputByteBufferNano.computeStringSize(19, this.interStExParams);
       }
       return i;
    }
    ...
    public ClientEvent$TaskEvent mergeFrom(CodedInputByteBufferNano p0){
       while (true) {
          int i = p0.readTag();
          switch (i){
              case 0:
              ...
              case 'J':
                ...
                p0.readMessage(this.taskDetailPackage);
                break;
              case 'R':
    ...
    public void writeTo(CodedOutputByteBufferNano p0){
       ...
       taction = this.status;
       if (taction != null) {
          p0.writeInt32(3, taction);
       }
       taction = this.urlPackage;
       if (taction != null) {
          p0.writeMessage(4, taction);
       }
       taction = this.elementPackage;
       if (taction != null) {
          p0.writeMessage(5, taction);
       }
       taction = this.trigger;
       if (taction != null) {
          p0.writeInt32(6, taction);
       }
       taction = this.resultPackage;
       if (taction != null) {
          p0.writeMessage(7, taction);
       }
       taction = this.contentPackage;
       if (taction != null) {
       ...
       taction = this.referElementPackage;
       if (taction != null) {
          p0.writeMessage(11, taction);
       }
       if (Float.floatToIntBits(this.ratio) != Float.floatToIntBits(0)) {
          p0.writeFloat(12, this.ratio);
       }
       if (!(this.contentWrapper).equals(str)) {
          p0.writeString(13, this.contentWrapper);
       }
       if (!(this.action2).equals(str)) {
          p0.writeString(14, this.action2);
       }
       taction = this.areaPackage;
       if (taction != null) {
          p0.writeMessage(15, taction);
       }
       taction = this.internalStidContainer;
       if (taction != null) {
       ...
       if (!(this.internalStidContainerJson).equals(str)) {
          p0.writeString(17, this.internalStidContainerJson);
       }
       taction = this.interStidContainer;
       if (taction != null) {
          p0.writeMessage(18, taction);
       }
       if (!(this.interStExParams).equals(str)) {
          p0.writeString(19, this.interStExParams);
       }
       super.writeTo(p0);
       return;
    }
