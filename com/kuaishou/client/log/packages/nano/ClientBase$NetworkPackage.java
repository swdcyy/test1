package com.kuaishou.client.log.packages.nano.ClientBase$NetworkPackage;
...
public final class ClientBase$NetworkPackage extends MessageNano	// class@000780
{
    ...
    public int computeSerializedSize(){
       ...
       if (!(this.dnsServers).equals(str)) {
          i = i + CodedOutputByteBufferNano.computeStringSize(4, this.dnsServers);
       }
       ttype = this.lteCellInfo;
       if (ttype != null) {
          i = i + CodedOutputByteBufferNano.computeMessageSize(5, ttype);
       }
       if (!Arrays.equals(this.ipv6, WireFormatNano.EMPTY_BYTES)) {
          i = i + CodedOutputByteBufferNano.computeBytesSize(6, this.ipv6);
       }
       return i;
    }
                   ...
                   if (i != 34) {
                      if (i != 42) {
                         if (i != 50) {
                            ...
                            this.ipv6 = p0.readBytes();
                         }
                      }else if(this.lteCellInfo == null){
                         this.lteCellInfo = new ClientBase$LteMobileCellInfo();
                      }
                      p0.readMessage(this.lteCellInfo);
                   }else {
                      this.dnsServers = p0.readString();
                   }
                }else {
    ...
    public void writeTo(CodedOutputByteBufferNano p0){
       ...
       if (!(this.dnsServers).equals(str)) {
          p0.writeString(4, this.dnsServers);
       }
       ttype = this.lteCellInfo;
       if (ttype != null) {
