package com.kuaishou.client.log.packages.nano.ClientBase$ApplicationPackage;
...
public final class ClientBase$ApplicationPackage extends MessageNano	// class@000779
{
    ...
    public ClientBase$ApplicationPackage clear(){
       ...
       this.system = false;
       this.running = false;
       this.firstInstallationTimestamp = 0;
       this.cachedSize = -1;
       return this;
    }
    public int computeSerializedSize(){
       ...
       tversionCode = this.firstInstallationTimestamp;
       if (tversionCode) {
          i = i + CodedOutputByteBufferNano.computeUInt64Size(7, tversionCode);
       }
       return i;
    }
                      ...
                      if (i != 40) {
                         if (i != 48) {
                            if (i != 56) {
                               ...
                               this.firstInstallationTimestamp = p0.readUInt64();
                            }
                         }else {
