package com.kuaishou.livestream.message.nano.LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant;
...
public final class LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant extends MessageNano	// class@00111b
{
    public String bizId;
    ...
    public LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant$PendantImageInfo largeImgInfo;
    public String liveStreamId;
    public String pendantLinkUrl;
    public long pendantStyle;
    public LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant$PendantImageInfo smallImgInfo;
    public String topImgLinkUrl;
    public static LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant[] _emptyArray;

    public void LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant(){
       super();
       this.clear();
    }
    public static LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant[] emptyArray(){
       if (LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant._emptyArray == null) {
          Object lAZY_INIT_LO = InternalNano.LAZY_INIT_LOCK;
          _monitor_enter(lAZY_INIT_LO);
          if (LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant._emptyArray == null) {
             LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant[] sCLiveBlindD = new LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant[0];
             LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant._emptyArray = sCLiveBlindD;
          }
          _monitor_exit(lAZY_INIT_LO);
       }
       return LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant._emptyArray;
    }
    public static LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant parseFrom(CodedInputByteBufferNano p0){
       return new LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant().mergeFrom(p0);
    }
    public static LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant parseFrom(byte[] p0){
       return MessageNano.mergeFrom(new LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant(), p0);
    }
    public LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant clear(){
       this.liveStreamId = "";
       this.pendantStyle = 0;
    ...
    public int computeSerializedSize(){
       ...
       LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant tpendantStyl = this.pendantStyle;
       if (tpendantStyl) {
          i = i + CodedOutputByteBufferNano.computeUInt64Size(2, tpendantStyl);
       }
       LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant tlargeImgInf = this.largeImgInfo;
    ...
    public LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant mergeFrom(CodedInputByteBufferNano p0){
       while (true) {
          int i = p0.readTag();
          switch (i){
              case 0:
              ...
              case 26:
                if (this.largeImgInfo == null) {
                   this.largeImgInfo = new LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant$PendantImageInfo();
                }
                p0.readMessage(this.largeImgInfo);
                break;
              case '"':
                if (this.smallImgInfo == null) {
                   this.smallImgInfo = new LiveBlindDateSignalMessages$SCLiveBlindDateShowAudiencePendant$PendantImageInfo();
                }
