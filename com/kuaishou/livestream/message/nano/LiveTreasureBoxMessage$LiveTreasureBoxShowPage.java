package com.kuaishou.livestream.message.nano.LiveTreasureBoxMessage$LiveTreasureBoxShowPage;
...
public final class LiveTreasureBoxMessage$LiveTreasureBoxShowPage extends MessageNano	// class@0013b0
{
    ...
    public int type;
    public static LiveTreasureBoxMessage$LiveTreasureBoxShowPage[] _emptyArray;

    public void LiveTreasureBoxMessage$LiveTreasureBoxShowPage(){
       super();
       this.clear();
    }
    public static LiveTreasureBoxMessage$LiveTreasureBoxShowPage[] emptyArray(){
       if (LiveTreasureBoxMessage$LiveTreasureBoxShowPage._emptyArray == null) {
          Object lAZY_INIT_LO = InternalNano.LAZY_INIT_LOCK;
          _monitor_enter(lAZY_INIT_LO);
          if (LiveTreasureBoxMessage$LiveTreasureBoxShowPage._emptyArray == null) {
             LiveTreasureBoxMessage$LiveTreasureBoxShowPage[] liveTreasure = new LiveTreasureBoxMessage$LiveTreasureBoxShowPage[0];
             LiveTreasureBoxMessage$LiveTreasureBoxShowPage._emptyArray = liveTreasure;
          }
          _monitor_exit(lAZY_INIT_LO);
       }
       return LiveTreasureBoxMessage$LiveTreasureBoxShowPage._emptyArray;
    }
    public static LiveTreasureBoxMessage$LiveTreasureBoxShowPage parseFrom(CodedInputByteBufferNano p0){
       return new LiveTreasureBoxMessage$LiveTreasureBoxShowPage().mergeFrom(p0);
    }
    public static LiveTreasureBoxMessage$LiveTreasureBoxShowPage parseFrom(byte[] p0){
       return MessageNano.mergeFrom(new LiveTreasureBoxMessage$LiveTreasureBoxShowPage(), p0);
    }
    public LiveTreasureBoxMessage$LiveTreasureBoxShowPage clear(){
       this.type = 0;
    ...
    public int computeSerializedSize(){
       int i3;
       LiveTreasureBoxMessage$LiveTreasureBoxShowPage tbgPict;
       object oobject;
       int i = super.computeSerializedSize();
       LiveTreasureBoxMessage$LiveTreasureBoxShowPage ttype = this.type;
       int i1 = 1;
       if (ttype != null) {
       ...
       if (ttype != null && ttype.length > 0) {
          ...
          int i4 = 0;
          int i5 = 0;
          LiveTreasureBoxMessage$LiveTreasureBoxShowPage tcapsuleColo = this.capsuleColor;
    ...
    public LiveTreasureBoxMessage$LiveTreasureBoxShowPage mergeFrom(CodedInputByteBufferNano p0){
       LiveTreasureBoxMessage$LiveTreasureBoxShowPage tbgPictV2;
       int i2;
