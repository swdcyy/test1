package com.tencent.open.TDialog$OnTimeListener;
...
public class TDialog$OnTimeListener extends DefaultUiListener	// class@000f36
{
    public String a;
    public String b;
    ...
    public void TDialog$OnTimeListener(Context p0,String p1,String p2,String p3,IUiListener p4){
       super();
    ...
    public static void a(TDialog$OnTimeListener p0,String p1){
       p0.a(p1);
    }
    ...
    public void onCancel(){
       TDialog$OnTimeListener te = this.e;
       if (te != null) {
          te.onCancel();
          this.e = null;
       }
