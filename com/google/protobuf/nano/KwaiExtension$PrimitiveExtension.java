package com.google.protobuf.nano.KwaiExtension$PrimitiveExtension;
...
public class KwaiExtension$PrimitiveExtension extends KwaiExtension	// class@000510
{
    public final int nonPackedTag;
    public final int packedTag;

    public void KwaiExtension$PrimitiveExtension(int p0,Class p1,int p2,boolean p3,int p4,int p5){
