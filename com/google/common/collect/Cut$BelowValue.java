package com.google.common.collect.Cut$BelowValue;
...
public final class Cut$BelowValue extends Cut	// class@0017ba
{
    public static final long serialVersionUID;

    public void Cut$BelowValue(Comparable p0){
       n.j(p0);
       super(p0);
    }
    ...
    public Cut withLowerBoundType(BoundType p0,i p1){
       ...
       Comparable uComparable = p1.d(this.endpoint);
       Cut uCut = (uComparable == null)? Cut.belowAll(): new Cut$AboveValue(uComparable);
       return uCut;
    }
    public Cut withUpperBoundType(BoundType p0,i p1){
       ...
       if (i != 1) {
          ...
          Comparable uComparable = p1.d(this.endpoint);
          Cut uCut = (uComparable == null)? Cut.aboveAll(): new Cut$AboveValue(uComparable);
          return uCut;
       }
    }
}
