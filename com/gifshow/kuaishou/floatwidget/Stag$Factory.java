package com.gifshow.kuaishou.floatwidget.Stag$Factory;
import zk.j;
...
import com.gifshow.kuaishou.floatwidget.model.StagFactoryksfeaturesftgrowthfloatwidget;

public class Stag$Factory implements j	// class@0015ca
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(ClientExtraParams.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(ClientExtraParams.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeaturesftgrowthfloatwidget stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeaturesftgrowthfloatwidget();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
