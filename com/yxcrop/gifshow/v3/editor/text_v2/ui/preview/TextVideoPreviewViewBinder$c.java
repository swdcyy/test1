package com.yxcrop.gifshow.v3.editor.text_v2.ui.preview.TextVideoPreviewViewBinder$c;
import xnd.c;
...
public final class TextVideoPreviewViewBinder$c implements c	// class@000b2a
{
    public final TextVideoPreviewViewBinder a;
    public final EditorDelegate b;

    public void TextVideoPreviewViewBinder$c(TextVideoPreviewViewBinder p0,EditorDelegate p1){
       this.a = p0;
       this.b = p1;
       super();
    }
    public EditDecorationBaseDrawer a(NewTextBaseElementData p0){
       NewEditTextElement newEditTextE = PatchProxy.applyOneRefs(p0, this, TextVideoPreviewViewBinder$c.class, "1");
       if (newEditTextE != PatchProxyResult.class) {
          ...
          if (p0 instanceof NewTextElementData) {
             ...
             if (p0.V0() == null) {
                ...
                a.D().w("TextPreviewViewBinder", "createInstance use default", objArray);
             }
             newEditTextE = new NewEditTextElement(p0, this.a.K);
