package com.yxcrop.gifshow.v3.editor.subtitle_v2.action.SubtitleAutoRefreshAction;
...
public final class SubtitleAutoRefreshAction extends EditDraftAction	// class@000ad8
{
    public final double videoDuration;

    public void SubtitleAutoRefreshAction(double p0){
       super(false, 1, null);
    ...
    public void performAction(c p0,c p1){
       if (PatchProxy.applyVoidTwoRefs(p0, p1, this, SubtitleAutoRefreshAction.class, "1")) {
          return;
       }
