package com.oplus.ocs.hyperboost.HyperBoostUnitImpl;
import com.oplus.ocs.hyperboost.HyperBoostUnitInterface;
import java.lang.Object;
import com.oplus.ocs.hyperboost.HyperBoostUnitImpl$1;
import com.oplus.ocs.hyperboost.HyperBoostUnitImpl$2;
...
public class HyperBoostUnitImpl implements HyperBoostUnitInterface	// class@000b2f
{
    public boolean mAuthCheckFlag;
    public HyperBoostUnitImpl$a mBindListener;
    public WeakReference mCallBacks;
    public Context mContext;
    public IHyperBoostService mHyperBoostServiceBinder;
    public IHyperBoostNotifier mIHyperBoostNotifier;
    public ServiceConnection mServiceConnection;

    public void HyperBoostUnitImpl(){
       super();
       this.mContext = null;
       this.mHyperBoostServiceBinder = null;
       this.mBindListener = null;
       this.mAuthCheckFlag = false;
       this.mServiceConnection = new HyperBoostUnitImpl$1(this);
       this.mIHyperBoostNotifier = new HyperBoostUnitImpl$2(this);
    }
    ...
    public void initialize(Context p0){
       ...
       HyperBoostUnitImpl tmContext = this.mContext;
       if (tmContext != null) {
