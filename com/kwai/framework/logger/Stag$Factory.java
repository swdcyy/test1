package com.kwai.framework.logger.Stag$Factory;
import zk.j;
...
import y96.m;
import com.kwai.framework.logger.config.StagFactorykskernelsframeworklogger;

public class Stag$Factory implements j	// class@000b89
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(m.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(m.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykskernelsframeworklogger stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactorykskernelsframeworklogger();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
