package com.kwai.framework.core.Stag$Factory;
import zk.j;
...
import ob6.h;
import com.kwai.framework.network.keyconfig.StagFactorykskernelsframeworkcore;

public class Stag$Factory implements j	// class@00150e
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(h.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(h.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykskernelsframeworkcore stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactorykskernelsframeworkcore();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
