package com.kwai.framework.network.NetworkSecurityLogInterceptor;
...
import com.kwai.framework.network.NetworkSecurityLogInterceptor$a;
...
public class NetworkSecurityLogInterceptor implements Interceptor	// class@00178c
{
    public boolean a;
    public List b;
    public List c;
    ...
    public final void a(){
       ...
       if (PatchProxy.applyVoid(objArray, this, NetworkSecurityLogInterceptor.class, "1")) {
          return;
       }
    ...
    public final void b(String p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, NetworkSecurityLogInterceptor.class, "5")) {
          return;
       }
    ...
    public Response intercept(Interceptor$Chain p0){
       ...
       String obj2 = PatchProxy.applyOneRefs(obj1, obj, networkSecur, "2");
       ...
       if (TextUtils.x(obj2)) {
          ...
          String str = "\"";
          if (!PatchProxy.applyVoidOneRefs(request, obj, networkSecur, "4")) {
          ...
          MediaType obj3 = PatchProxy.applyOneRefs(obj1, obj, networkSecur, "3");
          if (obj3 != patchProxyRe) {
             ...
             if (!TextUtils.x(obj1.toString()) && uobyteArray.length > 0) {
                ...
                byte[] uobyteArray1 = PatchProxy.applyTwoRefs(bytes, uobyteArray, obj, networkSecur, "7");
                ...
                if (!PatchProxy.applyVoidOneRefs(uobyteArray1, obj, networkSecur, "6")) {
