package com.kwai.feature.post.api.componet.prettify.makeup.model.MakeupSuite$TypeAdapter;
...
public final class MakeupSuite$TypeAdapter extends TypeAdapter	// class@0012fe
{
    public final Gson a;
    ...
    static {
       MakeupSuite$TypeAdapter.i = a.get(MakeupSuite.class);
    }
    public void MakeupSuite$TypeAdapter(Gson p0){
       super();
       this.a = p0;
    ...
    public Object read(a p0){
       JsonToken obj = PatchProxy.applyOneRefs(p0, this, MakeupSuite$TypeAdapter.class, "2");
             ...
             while (p0.l()) {
                ...
                switch (i){
                    case 0:
                      ...
                      break;
                    case 1:
                      obj.mImages = new KnownTypeAdapters$ArrayTypeAdapter(this.b, new o(this)).a(p0);
                      break;
                    case 2:
                      obj.mPassThroughParams = this.d.read(p0);
                      break;
                    case 3:
                      obj.mResources = new KnownTypeAdapters$ArrayTypeAdapter(this.b, new p(this)).a(p0);
                      break;
                    case 4:
                      obj.mResource = TypeAdapters.A.read(p0);
                      break;
                    case 5:
                      obj.mSuiteIntensity = KnownTypeAdapters$j.a(p0, obj.mSuiteIntensity);
                      break;
                    case 6:
                    case 7:
    ...
    public void write(b p0,Object p1){
       if (PatchProxy.applyVoidTwoRefs(p0, p1, this, MakeupSuite$TypeAdapter.class, "1")) {
       }else if(p1 == null){
          p0.u();
       }else {
          p0.e();
          ...
          if (p1.mImages != null) {
             p0.r("imageUrls");
             new KnownTypeAdapters$ArrayTypeAdapter(this.b, new m(this)).b(p0, p1.mImages);
          }
          if (p1.mImage != null) {
             p0.r("image");
          ...
          if (p1.mResources != null) {
             p0.r("resourceUrls");
             new KnownTypeAdapters$ArrayTypeAdapter(this.b, new n(this)).b(p0, p1.mResources);
          }
          if (p1.mTag != null) {
             p0.r("tag");
          ...
          p0.r("suitesIntensity");
          p0.J((double)p1.mSuiteIntensity);
