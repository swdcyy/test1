package com.kwai.feature.api.social.followSlide.model.Stag$Factory;
import zk.j;
...
import com.kwai.feature.api.social.followSlide.model.StagFactoryksfeatureapisfollowapifollowSlide;

public class Stag$Factory implements j	// class@0010d0
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(FollowSlideRecoGuide.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(FollowSlideRecoGuide.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeatureapisfollowapifollowSlide stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeatureapisfollowapifollowSlide();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
