package com.kwai.feature.api.feed.growth.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.model.config.StagFactoryksfeatureapisgrowthapi;

public class Stag$Factory implements j	// class@000ae0
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(UnLoginPopupConfig.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(UnLoginPopupConfig.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeatureapisgrowthapi stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeatureapisgrowthapi();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
