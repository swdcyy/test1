package com.kwai.feature.api.feed.home.common.stag.Stag$Factory;
import zk.j;
...
public class Stag$Factory implements j	// class@000ef7
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(HomeBubbleStartupPojo.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(HomeBubbleStartupPojo.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeatureapisfeedapihomecommonapi stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeatureapisfeedapihomecommonapi();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
