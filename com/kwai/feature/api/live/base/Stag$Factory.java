package com.kwai.feature.api.live.base.Stag$Factory;
import zk.j;
...
import com.kwai.feature.api.live.floatingscreen.data.StagFactoryksfeatureapisliveapislivefloatingscreenapi;

public class Stag$Factory implements j	// class@000f76
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(LiveEnterRoomEffectBackgroudPicInfo.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(LiveEnterRoomEffectBackgroudPicInfo.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactoryksfeatureapisliveapislivefloatingscreenapi stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactoryksfeatureapisliveapislivefloatingscreenapi();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
