package com.kwai.performance.fluency.page.monitor.view.FloatLayout;
...
public final class FloatLayout extends LinearLayout	// class@0010d6
{
    public int b;
    public int c;
    public int d;
    ...
    public void FloatLayout(Context p0,AttributeSet p1,int p2){
       ...
       a.o(context, "context");
       TimestampView timestampVie = new TimestampView(context, null, 0, 6, null);
       this.addView(p0);
    ...
    public final float a(float p0){
       ...
       a.o(resources, "MonitorManager.getApplication\(\).resources");
       return ((p0 * c.c(resources).density) + 0x3f000000);
    }
    public final void b(){
       this.b = j0.d(ViewConfiguration.get(k.b()));
