package com.kwai.performance.stability.crash.monitor.util.g;
...
import com.kwai.performance.stability.crash.monitor.util.g$a;

public class g	// class@000e49
{
    ...
    public static Object a(Object p0,String p1,Object[] p2){
       return g.c(p0.getClass(), p1, g.e(p2)).invoke(p0, g.f(p2));
    }
    public static Object b(String p0,String p1,Object[] p2){
       return g.c(Class.forName(p0), p1, g.e(p2)).invoke(null, g.f(p2));
    }
    public static Method c(Class p0,String p1,Class[] p2){
       ...
       return g.c(p0.getSuperclass(), p1, p2);
    }
    ...
    public static Class[] e(Object[] p0){
       ...
       if (p0 != null && p0.length > 0) {
          ...
          while (i < p0.length) {
             object oobject = p0[i];
             if (oobject != null && oobject instanceof g$a) {
    ...
    public static Object[] f(Object[] p0){
       ...
       if (p0 != null && p0.length > 0) {
          ...
          while (i < p0.length) {
             object oobject = p0[i];
             objArray[i] = (oobject != null && oobject instanceof g$a)? oobject.b: oobject;
             i = i + 1;
          }
       }else {
          objArray = null;
    ...
    public static Object h(String p0,String p1){
       return g.i(Class.forName(p0), p1);
    }
    ...
    public static void j(Object p0,String p1,Object p2){
       Class class = p0.getClass();
       Field uField = null;
       while (true) {
          if (uField == null) {
    ...
    public static RuntimeException k(Throwable p0){
