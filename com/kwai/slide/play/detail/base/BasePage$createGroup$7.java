package com.kwai.slide.play.detail.base.BasePage$createGroup$7;
import msd.l;
...
import com.kwai.slide.play.detail.base.BasePage$createGroup$7$a;
import eh5.v;
import eh5.q$a;
...
import com.kwai.slide.play.detail.base.BasePage$createGroup$7$b;
...
public final class BasePage$createGroup$7 extends Lambda implements l	// class@001753
{
    public final BasePage this$0;

    public void BasePage$createGroup$7(BasePage p0){
       this.this$0 = p0;
       super(1);
    }
    ...
    public final void invoke(List p0){
       ...
       Object obj = this;
       String obj1 = p0;
       if (PatchProxy.applyVoidOneRefs(obj1, obj, BasePage$createGroup$7.class, "1")) {
          return;
       }
       a.p(obj1, "$receiver");
       BasePage$createGroup$7 this$0 = obj.this$0;
       a = o.a;
       String name = b.class.getName();
       a.o(name, "DanmakuGroup::class.java.name");
       String str = "danmakuViewGroup create";
       if (this$0.G() != null && BasePage.U.a()) {
          ...
          if (uoa.d()) {
             ...
             g og = this$0.G();
             a.m(og);
             BasePage$createGroup$7$a uocreateGrou = null;
             v0 = a instanceof l;
             if (this$0) {
                a.m(name);
                if (this$0) {
                   if (og.e().b() && (!a.g(a, d0.a) && (!a.g(a, w.a) && (a.g(a, u.a) || a.g(a, b.a))))) {
                      ...
                      long l3 = l1;
                      og1 = og;
                      BasePage$createGroup$7$a uocreateGrou1 = new BasePage$createGroup$7$a(a, sparseArray, name, l2, str, 0, this, p0);
                      uoa1 = m;
                      this = str;
                      str1 = name;
                      BasePage$createGroup$7$a uocreateGrou2 = uocreateGrou;
                      oo = a;
                ...
                if (!this$0) {
                   ...
                   BasePage$createGroup$7$b uocreateGrou3 = new BasePage$createGroup$7$b(oo, sparseArray1, i, obj1, 0, this, this, p0);
                   l = uoa2.a();
