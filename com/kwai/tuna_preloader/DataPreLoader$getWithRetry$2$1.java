package com.kwai.tuna_preloader.DataPreLoader$getWithRetry$2$1;
import msd.l;
...
public final class DataPreLoader$getWithRetry$2$1 extends Lambda implements l	// class@001962
{
    public final v $emitter;
    public final DataPreLoader$getWithRetry$2 this$0;

    public void DataPreLoader$getWithRetry$2$1(DataPreLoader$getWithRetry$2 p0,v p1){
       this.this$0 = p0;
       this.$emitter = p1;
       super(1);
    }
    ...
    public final void invoke(ResultWrapper p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, DataPreLoader$getWithRetry$2$1.class, "1")) {
          return;
       }
