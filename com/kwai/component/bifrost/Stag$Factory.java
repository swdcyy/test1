package com.kwai.component.bifrost.Stag$Factory;
import zk.j;
...
import com.kwai.component.bifrost.startup.BifrostStartupCommonPojo;
import com.kwai.component.bifrost.startup.StagFactorykscomponentsbifrostactivity;

public class Stag$Factory implements j	// class@0020c9
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(BifrostStartupCommonPojo.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(BifrostStartupCommonPojo.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentsbifrostactivity stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactorykscomponentsbifrostactivity();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
