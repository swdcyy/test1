package com.kwai.component.kcube.model.Stag$Factory;
import zk.j;
...
import com.kwai.component.kcube.model.model.StagFactorykscomponentskcubekcubemodel;

public class Stag$Factory implements j	// class@000988
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (i) {
                ...
                j oj1 = this.d(BarInfo$Invalid.class, obj, 0);
                if (oj1 != null) {
                   _monitor_exit(this);
                   oj = oj1;
                }
             }
             oj = this.d(StartupPojo.class, obj, typeAdapter1);
             if (oj != null) {
                _monitor_exit(this);
             }else {
                goto label_005e ;
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentskcubekcubemodel stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (p0) {
             if (p0 == 1) {
                stagFactoryk = new StagFactorykscomponentskcubekcubemodel();
             }
          }else {
             stagFactoryk = new StagFactorykscomponentskcubekcubemodel();
          }
