package com.kwai.component.uiconfig.Stag$Factory;
import zk.j;
...
import com.kwai.component.uiconfig.homeslideplay.StagFactorykscomponentskwaiuiconfig;

public class Stag$Factory implements j	// class@000bd1
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(HomeSlidePlayStartupPojo.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(HomeSlidePlayStartupPojo.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentskwaiuiconfig stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactorykscomponentskwaiuiconfig();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
