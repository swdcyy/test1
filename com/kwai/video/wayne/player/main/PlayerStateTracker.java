package com.kwai.video.wayne.player.main.PlayerStateTracker;
import com.kwai.video.wayne.player.main.PlayerStateTracker$Companion;
import nsd.u;
...
public final class PlayerStateTracker	// class@000d8a
{
    ...
    public void PlayerStateTracker(){
       super();
       PlayerState[] playerStateA = new PlayerState[]{PlayerState.Idle};
       this.mStates = CollectionsKt__CollectionsKt.P(playerStateA);
    }
    ...
    public final void track(PlayerState p0,String p1){
