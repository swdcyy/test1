package com.kwai.video.clipkit.mv.ClipMvUtils$2;
...
public final class ClipMvUtils$2 implements NewSparkTemplateManager$SparkTemplateDelegate	// class@001a9f
{
    public final ExtraInterface val$extraInterface;
    public final String val$projectPlaceHolderImagePath;

    public void ClipMvUtils$2(ExtraInterface p0,String p1){
       this.val$extraInterface = p0;
       this.val$projectPlaceHolderImagePath = p1;
       super();
    }
    public String aeBuiltinResPath(){
       Object obj = PatchProxy.apply(null, this, ClipMvUtils$2.class, "2");
    ...
    public String fontPath(String p0){
       ArrayList obj = PatchProxy.applyOneRefs(p0, this, ClipMvUtils$2.class, "1");
       if (obj != PatchProxyResult.class) {
          return obj;
       }
       obj = new ArrayList();
