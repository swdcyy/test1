package com.kwai.video.krtc.observers.AudioSegmentPlayerObserver$ErrorType;
...
public final class AudioSegmentPlayerObserver$ErrorType extends Enum	// class@0007c5
{
    ...
    static {
       ...
       AudioSegmentPlayerObserver$ErrorType[] uErrorTypeAr = new AudioSegmentPlayerObserver$ErrorType[]{uErrorType,uErrorType1,uErrorType2,uErrorType3,uErrorType4};
