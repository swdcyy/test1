package com.kwai.video.stannis.audio.impl.StannisAudioManager$15;
...
public class StannisAudioManager$15 implements Runnable	// class@000c1d
{
    public final StannisAudioManager this$0;
    public final int val$currentOutType;
    public final int val$userSetOutType;

    public void StannisAudioManager$15(StannisAudioManager p0,int p1,int p2){
       this.this$0 = p0;
    ...
    public void run(){
       String str6;
       Object obj = this;
       if (PatchProxy.applyVoid(null, obj, StannisAudioManager$15.class, "1")) {
          return;
       }
       ...
       StannisAudioManager$15 this$0 = obj.this$0;
       if (this$0.config != null) {
          StannisAudioManager stannisAudio = 3;
          StannisAudioManager stannisAudio1 = 2;
          String str2 = "\(";
          String str3 = "USB";
          String str4 = "Speaker";
          ...
          switch (this$0.getOutputRouter()){
              ...
              default:
                ...
                if (obj.this$0.userSetOutputType != stannisAudio1) {
                   str5 = str4;
                }
                if (obj.this$0.isHeadsetConnected == null || obj.this$0.userSetOutputType != stannisAudio) {
                   str7 = str5;
                }
             ...
             if (inputRouter != 20) {
                if (inputRouter != 5) {
                   if (inputRouter != 6) {
                      ...
                      }else if(obj.this$0.userSetOutputType == 1 || obj.this$0.userSetOutputType == stannisAudio1){
                         str2 = "unknown";
                      }
                   ...
                   Log.i("StannisAudioManager", "[StannisAudioManager] curRecordingDeviceName:"+obj.this$0.curRecordingDeviceName+"outputname "+str4);
                   str3 = "Bluetooth\("+obj.this$0.curRecordingDeviceName+"\)";
                }else {
                   str6 = "Bluetooth";
                }
          ...
          this$0 = obj.this$0;
          StannisAudioManager$15 this$01 = obj.this$0;
          ...
          StannisAudioManager$15 this$02 = obj.this$0;
