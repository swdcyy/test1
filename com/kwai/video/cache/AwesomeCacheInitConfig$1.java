package com.kwai.video.cache.AwesomeCacheInitConfig$1;
...
public final class AwesomeCacheInitConfig$1 implements AwesomeCacheSoLoader	// class@0019f1
{
    public final Context val$appContext;
    public final AwesomeCacheSoLoader val$injectSoLoader;

    public void AwesomeCacheInitConfig$1(AwesomeCacheSoLoader p0,Context p1){
       this.val$injectSoLoader = p0;
       this.val$appContext = p1;
       super();
    }
    public void loadLibrary(String p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, AwesomeCacheInitConfig$1.class, "1")) {
          return;
       }
       AwesomeCacheInitConfig$1 tval$injectS = this.val$injectSoLoader;
