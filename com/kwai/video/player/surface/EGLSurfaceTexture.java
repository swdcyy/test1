package com.kwai.video.player.surface.EGLSurfaceTexture;
...
import com.kwai.video.player.surface.EGL;
...
public final class EGLSurfaceTexture implements SurfaceTexture$OnFrameAvailableListener, Runnable	// class@000ba2
{
    ...
    public final void dispatchOnFrameAvailable(float[] p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, EGLSurfaceTexture.class, "11")) {
          return;
       }
    ...
    public SurfaceTexture getSurfaceTexture(){
       Object obj = PatchProxy.apply(null, this, EGLSurfaceTexture.class, "8");
    ...
    public final boolean makeCurrentGL(){
       EGLSurfaceTexture obj = PatchProxy.apply(null, this, EGLSurfaceTexture.class, "6");
       if (obj != PatchProxyResult.class) {
    ...
    public void onEGLWillRelease(){
       ...
       EGLSurfaceTexture tcompatDrawe = this.compatDrawer;
       if (tcompatDrawe != null) {
          tcompatDrawe.release();
          this.compatDrawer = null;
       }
       tcompatDrawe = this.texture;
       if (tcompatDrawe != null) {
          tcompatDrawe.release();
    ...
    public void onFrameAvailable(SurfaceTexture p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, EGLSurfaceTexture.class, "9")) {
          return;
       }
    ...
    public void run(){
       if (PatchProxy.applyVoid(null, this, EGLSurfaceTexture.class, "10")) {
          return;
       }
       try{
          EGLSurfaceTexture ttexture = this.texture;
       ...
       if (this.makeCurrentGL()) {
          ...
          if (p0 == 2) {
             if (this.compatDrawer == null) {
                ...
                Timber.e("[EGL14ContextImpl] updateTexImage type = %d", objArray);
             }
