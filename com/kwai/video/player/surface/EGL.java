package com.kwai.video.player.surface.EGL;
...
import com.kwai.video.player.surface.EGL$GlException;
import java.util.Locale;
import java.lang.Boolean;
import java.lang.Integer;
import com.kwai.video.player.surface.EGL$1;
...
public class EGL	// class@000ba0
{
    ...
    public static void destroyEGLContext(EGLDisplay p0,EGLContext p1){
       ...
       int i = 0;
       boolean b = (p0 != null && !p0.equals(EGL14.EGL_NO_DISPLAY))? EGL14.eglMakeCurrent(p0, EGL14.EGL_NO_SURFACE, EGL14.EGL_NO_SURFACE, EGL14.EGL_NO_CONTEXT): false;
       if (!b) {
          Object[] objArray = new Object[i];
          Timber.e("[EGL] destroyEGLContext makeCurrent failed.", objArray);
          return;
       ...
       if (p0 != null && !p0.equals(EGL14.EGL_NO_DISPLAY)) {
          ...
          Timber.i("[EGL] eglTerminate display:"+p0, objArray1);
    ...
    public static EGLDisplay getDefaultDisplay(){
       ...
       obj = new Object[i];
       Timber.i("[EGL] eglInitialize display:"+uEGLDisplay, obj);
