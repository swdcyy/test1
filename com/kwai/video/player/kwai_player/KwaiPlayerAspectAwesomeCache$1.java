package com.kwai.video.player.kwai_player.KwaiPlayerAspectAwesomeCache$1;
...
public class KwaiPlayerAspectAwesomeCache$1 implements CacheSessionListener	// class@000b3a
{
    public final KwaiPlayerAspectAwesomeCache this$0;

    public void KwaiPlayerAspectAwesomeCache$1(KwaiPlayerAspectAwesomeCache p0){
       this.this$0 = p0;
       super();
    }
    public void onDownloadPaused(){
       if (PatchProxy.applyVoid(null, this, KwaiPlayerAspectAwesomeCache$1.class, "4")) {
          return;
       }
       KwaiPlayerAspectAwesomeCache mCacheSessio = this.this$0.mCacheSessionListener;
    ...
    public void onDownloadProgress(long p0,long p1){
       KwaiPlayerAspectAwesomeCache$1 u1 = KwaiPlayerAspectAwesomeCache$1.class;
    ...
    public void onDownloadResumed(){
       if (PatchProxy.applyVoid(null, this, KwaiPlayerAspectAwesomeCache$1.class, "5")) {
          return;
       }
       KwaiPlayerAspectAwesomeCache mCacheSessio = this.this$0.mCacheSessionListener;
       if (mCacheSessio != null) {
    ...
    public void onDownloadStarted(long p0,String p1,String p2,String p3,int p4,long p5){
       KwaiPlayerAspectAwesomeCache$1 u1 = this;
       KwaiPlayerAspectAwesomeCache$1 u11 = KwaiPlayerAspectAwesomeCache$1.class;
       ...
       KwaiPlayerAspectAwesomeCache mCacheSessio = u1.this$0.mCacheSessionListener;
       if (mCacheSessio != null) {
    ...
    public void onDownloadStopped(int p0,long p1,long p2,String p3,int p4,String p5,String p6,String p7,String p8){
       ...
       KwaiPlayerAspectAwesomeCache mCacheSessio = obj.this$0.mCacheSessionListener;
       if (mCacheSessio != null) {
          mCacheSessio.onDownloadStopped(p0, p1, p2, p3, p4, p5, p6, p7, p8);
       }else {
          Object[] objArray1 = new Object[0];
          Timber.e("onDownloadStopped, listener = null", objArray1);
       }
       return;
    }
    ...
    public void onSessionStart(String p0,long p1,long p2,long p3){
       if (PatchProxy.isSupport(KwaiPlayerAspectAwesomeCache$1.class) && PatchProxy.applyVoidFourRefs(p0, Long.valueOf(p1), Long.valueOf(p2), Long.valueOf(p3), this, KwaiPlayerAspectAwesomeCache$1.class, "1")) {
          return;
       }
       KwaiPlayerAspectAwesomeCache mCacheSessio = this.this$0.mCacheSessionListener;
       if (mCacheSessio != null) {
