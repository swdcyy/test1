package com.kwai.components.nearbymodel.Stag$Factory;
import zk.j;
...
import com.kwai.components.nearbymodel.model.StagFactorykscomponentsnearbymodel;

public class Stag$Factory implements j	// class@000c59
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (PatchProxy.isSupport(uFactory)) {
                Object obj1 = PatchProxy.applyThreeRefs(NearbyMapFeed$RoleInfo.class, obj, Integer.valueOf(0), this, Stag$Factory.class, "4");
                if (obj1 != patchProxyRe) {
                   oj = obj1;
                }else {
                label_0063 :
                   String str = Stag$Factory.b(NearbyMapFeed$RoleInfo.class);
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentsnearbymodel stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (!p0) {
             stagFactoryk = new StagFactorykscomponentsnearbymodel();
          }
          obj = stagFactoryk;
          goto label_003f ;
       }
