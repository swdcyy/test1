package com.kwai.components.livecommonmodel.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.models.StagFactorykscomponentslivecommonmodel;
import com.yxcorp.gifshow.model.StagFactorykscomponentslivecommonmodel;

public class Stag$Factory implements j	// class@000c58
{
       ...
       if (oj != patchProxyRe) {
          ...
          if (integer != null) {
             ...
             if (i) {
                ...
                j oj1 = this.d(NotifySubCount.class, obj, 0);
                if (oj1 != null) {
                   _monitor_exit(this);
                   oj = oj1;
                }
             }
             oj = this.d(Gift.class, obj, typeAdapter1);
             if (oj != null) {
                _monitor_exit(this);
             }else {
                goto label_005e ;
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentslivecommonmodel stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (p0) {
             if (p0 == 1) {
                stagFactoryk = new StagFactorykscomponentslivecommonmodel();
             }
          }else {
             stagFactoryk = new StagFactorykscomponentslivecommonmodel();
          }
