package com.kwai.components.commercialmodel.Stag$Factory;
import zk.j;
...
import com.yxcorp.gifshow.commercial.model.StagFactorykscomponentscommercialmodel;
import com.kuaishou.commercial.config.StagFactorykscomponentscommercialmodel;
import com.kuaishou.android.model.ads.StagFactorykscomponentscommercialmodel;

public class Stag$Factory implements j	// class@000c0a
{
          ...
          if (integer != null) {
             ...
             if (i) {
                if (i != 1) {
                   ...
                   label_0061 :
                      oj = this.d(SplashBaseInfo.class, obj, typeAdapter1);
                      if (oj != null) {
                         _monitor_exit(this);
                      }else {
                         goto label_006b ;
                ...
                oj1 = this.d(SplashInfo$CardInfo.class, obj, 0);
                if (oj1 != null) {
                   _monitor_exit(this);
                label_0055 :
                   oj = oj1;
             ...
             oj1 = this.d(StartUpAdConfig$IdMapping.class, obj, 1);
             if (oj1 != null) {
                _monitor_exit(this);
                goto label_0055 ;
             }else {
    ...
    public final j c(int p0){
       ...
       obj = this.c[p0];
       if (obj == null) {
          StagFactorykscomponentscommercialmodel stagFactoryk = null;
          if (PatchProxy.isSupport(uFactory)) {
          ...
          if (p0) {
             if (p0 != 1) {
                if (p0 == 2) {
                   stagFactoryk = new StagFactorykscomponentscommercialmodel();
                }
             }else {
                stagFactoryk = new StagFactorykscomponentscommercialmodel();
             }
