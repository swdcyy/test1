package com.airbnb.lottie.ex.model.layer.a;
import c5.e;
import d5.a$a;
import g5.e;
import a5.f;
...
public abstract class a implements e, a$a, e	// class@000dbb
{
    public final Path a;
    ...
    public void a(f p0,Layer p1){
       ...
       this.o = p1;
       this.l = p1.g()+"#draw";
       if (p1.f() == Layer$MatteType.INVERT) {
    ...
    public void a(Canvas p0,Matrix p1,int p2){
       ...
       if (uoa.v == null || uoa.o.v != null) {
          ...
          if (!this.m() && !this.l()) {
             ...
             a h = uoa.h;
             float f = 0;
             if (this.m() && uoa.o.f() != Layer$MatteType.INVERT) {
                uoa.j.set(f, f, f, f);
