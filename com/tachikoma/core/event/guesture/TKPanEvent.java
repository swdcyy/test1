package com.tachikoma.core.event.guesture.TKPanEvent;
...
public class TKPanEvent extends TKBaseEvent	// class@000dc3
{
    public HashMap mPosition;

    public void TKPanEvent(){
       super();
       this.mPosition = new HashMap();
    }
    public void configWithData(HashMap p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, TKPanEvent.class, "1")) {
          return;
       }
