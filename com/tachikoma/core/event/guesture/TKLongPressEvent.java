package com.tachikoma.core.event.guesture.TKLongPressEvent;
...
public class TKLongPressEvent extends TKBaseEvent	// class@000dc2
{
    public HashMap mPosition;

    public void TKLongPressEvent(){
       super();
       this.mPosition = new HashMap();
    }
    public void configWithData(HashMap p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, TKLongPressEvent.class, "1")) {
          return;
       }
