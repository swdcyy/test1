package com.jaredrummler.android.processes.models.Stat;
import com.jaredrummler.android.processes.models.ProcFile;
import com.jaredrummler.android.processes.models.Stat$a;
...
public final class Stat extends ProcFile	// class@0006e3
{
    public final String[] fields;
    public static final Parcelable$Creator CREATOR;

    static {
       Stat.CREATOR = new Stat$a();
    }
    public void Stat(Parcel p0){
       super(p0);
       this.fields = p0.createStringArray();
    }
    public void Stat(Parcel p0,Stat$a p1){
       super(p0);
    }
    public void Stat(String p0){
       super(p0);
       this.fields = (this.content).split("\\s+");
    }
    public static Stat get(int p0){
       Object[] objArray = new Object[]{Integer.valueOf(p0)};
       return new Stat(String.format("/proc/%d/stat", objArray));
    }
    public long arg_end(){
