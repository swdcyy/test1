...
public class h implements b	// class@000302
{
    ...
    public Object a(f p0){
       TKTextArea tKTextArea = PatchProxy.applyOneRefs(p0, this, h.class, "1");
       if (tKTextArea != PatchProxyResult.class) {
       }else {
          tKTextArea = new TKTextArea(p0);
       }
       return tKTextArea;
    }
    ...
    public Object e(Object p0,String p1){
       ...
       switch (i){
           ...
           case 11:
             return Integer.valueOf(p0.autoResize);
           case 12:
             return Integer.valueOf(p0.rows);
           case 13:
             return p0.text;
           case 14:
    ...
    public Object f(Object p0,String p1,Object[] p2){
       int this;
       Object obj = PatchProxy.applyThreeRefs(p0, p1, p2, this, h.class, "8");
       if (obj != PatchProxyResult.class) {
          return obj;
       }
       Objects.requireNonNull(p1);
    ...
    public String l(){
       return "enabled,oncut,maxlength,text,disable,style,focused,nativeID,onblur,rows,placeholder,onfocus,onFocus,disallowParentInterceptTouchEvent,onpaste,autoResize,onPress,types,oncopy,readonly,pivotPoint,oninput,onchange,returntype,value,onLongPress,autofocus,setRotate,blur,pauseAnimations,startViewAnimation,setScaleX,setTranslateX,clear,_setVNode,getOrigin,setTranslateY,addAnimation,removeAllAnimation,setRotateY,setBackgroundColor,clearFocus,focus,setGradientBgColor,setScaleY,getSize,layout,resumeAnimations,removeEventListener,getLocationOnScreen,removeSelf,observeNextLayout,setRotateX,setVisibility,invokeNativeFunctionWithJSONString,addEventListener,removeAnimation";
    }
}
