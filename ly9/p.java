...
public final class p implements g	// class@002ec5
{
    public final q b;
    ...
    public final void accept(Object p0){
       ...
       a a = p0.a;
       g b1 = tb.c.b;
       if (!PatchProxy.isSupport(a.class) || !PatchProxy.applyVoidFourRefs(h, Integer.valueOf(b), a, b1, null, a.class, "3")) {
          ClientContent$ContentPackage uContentPack = new ClientContent$ContentPackage();
          uContentPack.photoPackage = w1.f(b1.mEntity);
          h oh = h.m("2859460", "BARRAGE_POPUP");
          i3 oi3 = i3.f();
          oi3.d("click_area", "head");
