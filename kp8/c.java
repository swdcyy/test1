...
public class c implements b	// class@002c0a
{
    ...
    public Object a(f p0){
       TKView tKView = PatchProxy.applyOneRefs(p0, this, c.class, "1");
       if (tKView != PatchProxyResult.class) {
       }else {
          tKView = new TKView(p0);
       }
       return tKView;
    }
    ...
    public Object f(Object p0,String p1,Object[] p2){
       int this;
       Object obj = PatchProxy.applyThreeRefs(p0, p1, p2, this, c.class, "8");
       if (obj != PatchProxyResult.class) {
          return obj;
       }
       Objects.requireNonNull(p1);
    ...
    label_01cb :
       ...
       switch (i){
           ...
           case 18:
             p0.insertBefore(a.a(p2, 0), a.a(p2, 1));
             return p1;
           case 19:
             p0.replace(a.a(p2, 0), a.a(p2, 1));
             return p1;
           case 20:
    ...
    public String l(){
       return "clipChildren,pivotPoint,disable,nativeID,style,enabled,disallowParentInterceptTouchEvent,onPress,onLongPress,setVisibility,getLocationOnScreen,invokeNativeFunctionWithJSONString,pauseAnimations,setScaleY,removeAnimation,setTranslateY,addEventListener,appendChild,resumeAnimations,insertBefore,setGradientBgColor,addAnimation,setRotateX,removeSelf,getElementById,removeChild,observeNextLayout,layout,removeEventListener,getSize,startViewAnimation,setTranslateX,setRotate,_setVNode,removeAllAnimation,removeAll,replaceChild,getOrigin,setBackgroundColor,setRotateY,setScaleX";
    }
}
