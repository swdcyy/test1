...
public class c implements Interpolator	// class@00046c
{
    public int a;
    ...
    public float getInterpolation(float p0){
       ...
       if (PatchProxy.isSupport(c.class)) {
          obj = PatchProxy.applyOneRefs(Float.valueOf(p0), this, c.class, "2");
       ...
       while (obj < 0.00f) {
          ...
          f = f1 / 4096.00f;
          if (c.a((double)f, 0, (double)this.b.x, (double)this.c.x, 0x3ff0000000000000) - (double)p0 >= 0) {
             this.a = obj;
             break ;
          }
          int i = obj + 1;
       }
       double d = c.a((double)f, 0, (double)this.b.y, (double)this.c.y, 0x3ff0000000000000);
