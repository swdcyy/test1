...
public final class i$b implements GrowthTestLayout$Companion$a	// class@00277e
{
    ...
    public void a(Object p0){
       if (PatchProxy.applyVoidOneRefs(p0, this, i$b.class, "2")) {
          ...
          int i = 0x7f110668;
          String str = (p0 == null)? "测试配置已清空": " 修改成功: 当前时间间隔为 "+p0+" 秒 ";
          i.d(i, str);
          k.b.c("KEY_CLEANER_NOTIFICATION_TIME", p0);
       }
       return;
    }
    public Object b(){
       ...
       Object[] objArray1 = PatchProxy.apply(objArray, this, i$b.class, "1");
       if (objArray1 != PatchProxyResult.class) {
       }else {
          k b = k.b;
          String str = "KEY_CLEANER_NOTIFICATION_TIME";
          int i = 1;
          if (!u.S1(str)) {
             try{
