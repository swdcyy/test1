...
public class k implements b	// class@0025d2
{
    ...
    public Object a(f p0){
       TKMarqueeText tKMarqueeTex = PatchProxy.applyOneRefs(p0, this, k.class, "1");
       if (tKMarqueeTex != PatchProxyResult.class) {
       }else {
          tKMarqueeTex = new TKMarqueeText(p0);
       }
       return tKMarqueeTex;
    }
    public void b(Object p0,Map p1){
       if (PatchProxy.applyVoidTwoRefs(p0, p1, this, k.class, "6")) {
          return;
       }
    ...
    public Object e(Object p0,String p1){
       Object obj = PatchProxy.applyTwoRefs(p0, p1, this, k.class, "5");
       if (obj != PatchProxyResult.class) {
          return obj;
       }
    ...
    public Object f(Object p0,String p1,Object[] p2){
       int this;
       Object obj = PatchProxy.applyThreeRefs(p0, p1, p2, this, k.class, "8");
       if (obj != PatchProxyResult.class) {
          return obj;
       }
       Objects.requireNonNull(p1);
    ...
    public boolean k(Object p0,String p1,Object p2){
       Object obj = PatchProxy.applyThreeRefs(p0, p1, p2, this, k.class, "4");
       if (obj != PatchProxyResult.class) {
          return obj.booleanValue();
       }
       Objects.requireNonNull(p1);
    ...
    public String l(){
       return "pivotPoint,enabled,onLongPress,style,onPress,nativeID,text,disallowParentInterceptTouchEvent,disable,setRotateX,resumeAnimations,getOrigin,setRotateY,addEventListener,setVisibility,pauseAnimations,removeAllAnimation,invokeNativeFunctionWithJSONString,setTranslateX,observeNextLayout,setBackgroundColor,layout,addAnimation,setTranslateY,setText,setScaleX,setGradientBgColor,removeSelf,setRotate,removeEventListener,startViewAnimation,getSize,getLocationOnScreen,setScaleY,removeAnimation,_setVNode";
    }
}
