package kotlinx.coroutines.flow.internal.CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$3;
import msd.p;
...
public final class CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$3 extends SuspendLambda implements p	// class@001b1f
{
    ...
    public void CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$3(c p0,CombineKt$combineTransformInternal$2 p1,Ref$BooleanRef p2,y p3,Ref$ObjectRef p4,Ref$ObjectRef p5,Ref$BooleanRef p6,y p7){
       this.this$0 = p1;
    ...
    public final c create(Object p0,c p1){
       CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$3 uocombineTra = new CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$3(p1, this.this$0, this.$firstIsClosed$inlined, this.$firstChannel$inlined, this.$firstValue$inlined, this.$secondValue$inlined, this.$secondIsClosed$inlined, this.$secondChannel$inlined);
       v9.p$0 = p0;
       return v9;
    }
    ...
    public final Object invokeSuspend(Object p0){
       Object obj = b.h();
       CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$3 tlabel = this.label;
       if (tlabel != null) {
          if (tlabel == 1) {
             j0.n(p0);
          }else {
          ...
          j0.n(p0);
          p0 = this.p$0;
          this.$secondValue$inlined.element = p0;
