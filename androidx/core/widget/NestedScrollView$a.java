package androidx.core.widget.NestedScrollView$a;
import a2.a;
...
public class NestedScrollView$a extends a	// class@00072c
{

    public void NestedScrollView$a(){
       super();
    }
    ...
    public boolean h(View p0,int p1,Bundle p2){
       ...
       if (p1 != 4096) {
          if (p1 != 8192 && p1 != 0x1020038) {
             ...
             if (p1 != p0.getScrollY()) {
                p0.smoothScrollTo(false, p1, true);
                return true;
             }else {
                return false;
             }
