...
public final class g$c extends a$b	// class@002008
{
    public final g a;
    ...
    public void b(){
       ...
       this.a.i = LiveMultiLineArenaLiveState.SHOW_END;
       return;
    }
    public boolean d(Message p0){
       Integer obj = PatchProxy.applyOneRefs(p0, this, g$c.class, "2");
       ...
       if (obj != null && !obj.intValue()) {
          g$c ta = this.a;
          ta.v(ta.f, LiveMultiLineArenaLiveState.SHOW_END, LiveMultiLineArenaLiveState.IDLE, p0.obj);
          return true;
       }else {
          return false;
       }
