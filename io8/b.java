...
public class b implements b	// class@002702
{
    ...
    public Object a(f p0){
       TKViewPager tKViewPager = PatchProxy.applyOneRefs(p0, this, b.class, "1");
       if (tKViewPager != PatchProxyResult.class) {
       }else {
          tKViewPager = new TKViewPager(p0);
       }
       return tKViewPager;
    }
    ...
    public Object e(Object p0,String p1){
       ...
       switch (i){
           ...
           case 4:
             return p0.onPageScrollStateChangedCallback;
           case 5:
             return p0.mOnLongPressListener;
           case 6:
             return p0.style;
           case 7:
             return p0.onPageScrollCallback;
           case 8:
             return Integer.valueOf(p0.initialPage);
           case 9:
             return p0.mPivotPoint;
           case 10:
             return p0.onPageSelectedCallback;
           case 11:
             return Boolean.valueOf(p0.horizontal);
           case 12:
    ...
    label_0193 :
       ...
       switch (i){
           ...
           case 5:
             ...
             return p1;
           case 6:
             p0.setCurrentPageIndex(a.m(a.c(p2, 0)), a.b(p2, 1).booleanValue());
             return p1;
           case 7:
       ...
       switch (i){
          ...
          label_017e :
           ...
           case 10:
             ...
             break;
           case 11:
             p0.setHorizontal(p2.booleanValue());
             goto label_017e ;
             break;
           case 12:
    ...
    public String l(){
       return "style,initialPage,disable,enabled,onPageSelected,onPress,nativeID,disallowParentInterceptTouchEvent,onPageScrollStateChanged,horizontal,scrollEnabled,scrollEventThrottle,pivotPoint,onLongPress,onPageScroll,getSize,startViewAnimation,setGradientBgColor,pauseAnimations,removeSelf,layout,setRotate,removeEventListener,addAnimation,_setVNode,removeAllAnimation,setBackgroundColor,observeNextLayout,setTranslateX,removeAnimation,setVisibility,setRotateX,getOrigin,setScaleX,setTranslateY,addEventListener,setPages,resumeAnimations,setScaleY,setRotateY,invokeNativeFunctionWithJSONString,setCurrentPageIndex,getLocationOnScreen";
    }
}
