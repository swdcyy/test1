...
public class c$h extends q	// class@00040d
{
    public final c d;

    public void c$h(c p0,RoomDatabase p1){
       this.d = p0;
       super(p1);
    }
    public String d(){
    ...
    public void g(f p0,Object p1){
       if (PatchProxy.applyVoidTwoRefs(p0, p1, this, c$h.class, "1")) {
       }else {
          ...
          p0.bindLong(11, (long)p1.releaseCode);
          appId = p1.buildEnv;
          i = 12;
          if (appId == null) {
             p0.bindNull(i);
          ...
          p0.bindLong(13, (long)p1.independent);
       }
       return;
    }
}
