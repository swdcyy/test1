...
public final class a implements f	// class@000033
{
    public final String a;

    public void a(){
       super();
       this.a = SettingItem.ACCOUNT_SECURITY.getKey();
    }
    public b a(BaseFragment p0,SettingItemStencil p1){
       AccountSecurityItem uAccountSecu = PatchProxy.applyTwoRefs(p0, p1, this, a.class, "1");
       if (uAccountSecu != PatchProxyResult.class) {
       }else {
          a.p(p0, "targetFragment");
          a.p(p1, "data");
          uAccountSecu = new AccountSecurityItem(p0, p1);
       }
       return uAccountSecu;
    }
    public String b(){
