...
import com.tachikoma.core.component.progressbar.TKProgressBarView;
...
public class a implements b	// class@0020de
{
    ...
    public Object a(f p0){
       TKProgressBarView tKProgressBa = PatchProxy.applyOneRefs(p0, this, a.class, "1");
       if (tKProgressBa != PatchProxyResult.class) {
       }else {
          tKProgressBa = new TKProgressBarView(p0);
       }
       return tKProgressBa;
    }
    ...
    public Object e(Object p0,String p1){
       ...
       switch (i){
           ...
           case 3:
             return Double.valueOf(p0.progress);
           case 4:
           ...
           case 6:
             return p0.style;
           case 7:
             return Boolean.valueOf(p0.animating);
           case 8:
    ...
    public void g(Object p0,String p1,Object p2){
       ...
       switch (i){
           ...
           case 20:
             ...
             break;
           case 21:
             p0.setCornerRadius(a.l(p2));
             break;
           case 22:
             p0.setBorderBottomRightRadius(a.m(p2));
             break;
           case 23:
             p0.setIndeterminate(p2.booleanValue());
             break;
           case 24:
       ...
       switch (i){
          ...
          label_0115 :
           ...
           case 6:
             ...
             break;
           case 7:
             p0.setAnimating(p2.booleanValue());
             goto label_0115 ;
             break;
           case 8:
    ...
    public String l(){
       return "progress,disable,pivotPoint,disallowParentInterceptTouchEvent,nativeID,onPress,style,animating,color,onLongPress,enabled,removeSelf,getLocationOnScreen,removeAnimation,addAnimation,setTranslateY,removeAllAnimation,setGradientBgColor,layout,removeEventListener,addEventListener,invokeNativeFunctionWithJSONString,getSize,resumeAnimations,setScaleY,getOrigin,setVisibility,pauseAnimations,setRotateY,setBackgroundColor,setTranslateX,observeNextLayout,setRotateX,_setVNode,setScaleX,startViewAnimation,setColor,setRotate,setProgress";
    }
}
