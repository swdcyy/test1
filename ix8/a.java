...
public class a implements Interpolator	// class@002730
{
    public int a;
    ...
    public static a b(){
       ...
       return new a(0x3f000000, 0, 0.30f, 0x3f800000);
    }
    public float getInterpolation(float p0){
       a obj;
       if (PatchProxy.isSupport(a.class)) {
          obj = PatchProxy.applyOneRefs(Float.valueOf(p0), this, a.class, "2");
          if (obj != PatchProxyResult.class) {
