...
public class n extends y	// class@002bfa
{
    public ArrayList h;
    public ArrayList i;
    public ArrayList j;
    ...
    public boolean B(RecyclerView$ViewHolder p0){
       Object obj = PatchProxy.applyOneRefsWithListener(p0, this, n.class, "4");
    ...
    public boolean C(RecyclerView$ViewHolder p0,RecyclerView$ViewHolder p1,int p2,int p3,int p4,int p5){
       ...
       if (oobject == oobject1) {
          ...
          n$d uod = new n$d(p0, p1, p2, p3, p4, p5);
    ...
    public boolean D(RecyclerView$ViewHolder p0,int p1,int p2,int p3,int p4){
       ...
       n$e uoe = new n$e(p0, i1, i2, p3, p4);
       on.j.add(v11);
       PatchProxy.onMethodExit(n.class, "6");
       return 1;
    }
    public boolean E(RecyclerView$ViewHolder p0){
       Object obj = PatchProxy.applyOneRefsWithListener(p0, this, n.class, "2");
       if (obj != PatchProxyResult.class) {
          return obj.booleanValue();
       }
       this.Q(p0);
    ...
    public void L(List p0){
       if (PatchProxy.applyVoidOneRefsWithListener(p0, this, n.class, "18")) {
          return;
       }
       int i = p0.size();
       i = i - 1;
    ...
    public void M(){
       if (PatchProxy.applyVoidWithListener(null, this, n.class, "16")) {
          return;
       }
       if (!this.p()) {
          this.i();
    ...
    public final void N(List p0,RecyclerView$ViewHolder p1){
       if (PatchProxy.applyVoidTwoRefsWithListener(p0, p1, this, n.class, "10")) {
          return;
       }
       int i = p0.size();
       i = i - 1;
    ...
    public final void O(n$d p0){
       if (PatchProxy.applyVoidOneRefsWithListener(p0, this, n.class, "11")) {
          return;
       }
       n$d a = p0.a;
       if (a != null) {
       ...
       PatchProxy.onMethodExit(n.class, "11");
       return;
    }
    public final boolean P(n$d p0,RecyclerView$ViewHolder p1){
       Object obj = PatchProxy.applyTwoRefsWithListener(p0, p1, this, n.class, "12");
       if (obj != PatchProxyResult.class) {
          return obj.booleanValue();
       }
       ...
       if (p0.b == p1) {
          ...
          PatchProxy.onMethodExit(n.class, "12");
          return b;
       }
    ...
    public final void Q(RecyclerView$ViewHolder p0){
       if (PatchProxy.applyVoidOneRefsWithListener(p0, this, n.class, "14")) {
          return;
       }
       if (n.t == null) {
          n.t = new ValueAnimator().getInterpolator();
       }
       p0.itemView.animate().setInterpolator(n.t);
       this.j(p0);
       PatchProxy.onMethodExit(n.class, "14");
       return;
    }
    public boolean g(RecyclerView$ViewHolder p0,List p1){
       Object obj = PatchProxy.applyTwoRefsWithListener(p0, p1, this, n.class, "19");
       if (obj != PatchProxyResult.class) {
          return obj.booleanValue();
       }
    ...
    public void j(RecyclerView$ViewHolder p0){
       ...
       if (PatchProxy.applyVoidOneRefsWithListener(p0, this, n.class, "13")) {
          return;
       }
       ...
       this.p.remove(p0);
       this.M();
       PatchProxy.onMethodExit(n.class, "13");
       return;
    }
    public void k(){
       RecyclerView$ViewHolder itemView;
       ArrayList uArrayList1;
       if (PatchProxy.applyVoidWithListener(null, this, n.class, "17")) {
          return;
       }
       int i = this.j.size() - 1;
       float f = 0;
       while (i >= 0) {
          n$e uoe = this.j.get(i);
    ...
    public boolean p(){
       n on = n.class;
       Object obj = PatchProxy.applyWithListener(null, this, on, "15");
       if (obj != PatchProxyResult.class) {
          return obj.booleanValue();
       }
    ...
    public void v(){
       ...
       if (!i && (!i1 && (!i3 && !i2))) {
          ...
          while (iterator.hasNext()) {
             ...
             String str = "3";
             if (PatchProxy.applyVoidOneRefsWithListener(viewHolder, this, n.class, str)) {
                continue ;
             }
             ...
             viewProperty.setDuration(this.o()).alpha(0).scaleX(0x3f733333).scaleY(0x3f733333).setListener(new o(this, viewHolder, viewProperty, itemView)).start();
          ...
          if (i1) {
             ...
             this.j.clear();
             n$a uoa = new n$a(this, uArrayList);
             if (i) {
          ...
          if (i2) {
             ...
             this.k.clear();
             n$b uob = new n$b(this, uArrayList);
             if (i) {
          ...
          if (i3) {
             ...
             this.i.clear();
             n$c uoc = new n$c(this, uArrayList1);
             if (!i && (i1 || i2)) {
                long l = 0;
                long l1 = (i)? this.o(): l;
                long l2 = (i1)? this.n(): l;
