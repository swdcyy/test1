package io.reactivex.internal.operators.observable.ObservableTimeoutTimed$TimeoutObserver;
import brd.y;
import crd.b;
...
public final class ObservableTimeoutTimed$TimeoutObserver extends AtomicLong implements y, b, ObservableTimeoutTimed$b	// class@00137f
{
    ...
    public void ObservableTimeoutTimed$TimeoutObserver(y p0,long p1,TimeUnit p2,z$c p3){
       super();
       this.actual = p0;
       this.timeout = p1;
       this.unit = p2;
