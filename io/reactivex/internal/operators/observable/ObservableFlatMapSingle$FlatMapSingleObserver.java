package io.reactivex.internal.operators.observable.ObservableFlatMapSingle$FlatMapSingleObserver;
import brd.y;
import crd.b;
...
public final class ObservableFlatMapSingle$FlatMapSingleObserver extends AtomicInteger implements y, b	// class@001310
{
    ...
    public void ObservableFlatMapSingle$FlatMapSingleObserver(y p0,o p1,boolean p2){
       super();
       this.actual = p0;
       this.mapper = p1;
       this.delayErrors = p2;
    ...
    public void drainLoop(){
       ObservableFlatMapSingle$FlatMapSingleObserver tactual = this.actual;
       ObservableFlatMapSingle$FlatMapSingleObserver tactive = this.active;
       ObservableFlatMapSingle$FlatMapSingleObserver tqueue = this.queue;
       int i = 1;
       while (true) {
          if (this.cancelled != null) {
             ...
             int i1 = 0;
             ObservableFlatMapSingle$FlatMapSingleObserver uFlatMapSing = (!tactive.get())? 1: null;
             a uoa = tqueue.get();
    ...
    public void innerError(ObservableFlatMapSingle$FlatMapSingleObserver$InnerObserver p0,Throwable p1){
       this.set.b(p0);
    ...
    public void innerSuccess(ObservableFlatMapSingle$FlatMapSingleObserver$InnerObserver p0,Object p1){
       this.set.b(p0);
       if (!this.get()) {
          int i = 0;
    ...
    public void onNext(Object p0){
       ...
       ObservableFlatMapSingle$FlatMapSingleObserver$InnerObserver uFlatMapSing = new ObservableFlatMapSingle$FlatMapSingleObserver$InnerObserver(this);
       if (this.cancelled == null && this.set.c(uFlatMapSing)) {
          p0.b(uFlatMapSing);
       }
       return;
    }
