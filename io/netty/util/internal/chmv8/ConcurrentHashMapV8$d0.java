package io.netty.util.internal.chmv8.ConcurrentHashMapV8$d0;
...
public final class ConcurrentHashMapV8$d0 extends ConcurrentHashMapV8$z implements ConcurrentHashMapV8$f	// class@001150
{
    public long h;

    public void ConcurrentHashMapV8$d0(ConcurrentHashMapV8$r[] p0,int p1,int p2,int p3,long p4){
       super(p0, p1, p2, p3);
       this.h = p4;
    }
    public long a(){
    ...
    public ConcurrentHashMapV8$f c(){
       ...
       if (i <= te) {
          ...
          long l1 = this.h >> l;
          this.h = l1;
          ConcurrentHashMapV8$d0 uod0 = new ConcurrentHashMapV8$d0(this.b, this.g, i, tf, l1);
       }
       return uof;
    }
