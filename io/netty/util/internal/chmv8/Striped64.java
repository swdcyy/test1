package io.netty.util.internal.chmv8.Striped64;
...
import io.netty.util.internal.chmv8.Striped64$a;
...
public abstract class Striped64 extends Number	// class@00117e
{
    public long base;
    public int busy;
    public Striped64$b[] cells;
    ...
    static {
       ...
       try{
          ...
          Striped64.b = unsafe;
          Striped64.c = unsafe.objectFieldOffset(Striped64.class.getDeclaredField("base"));
          Striped64.d = unsafe.objectFieldOffset(Striped64.class.getDeclaredField("busy"));
    ...
    public static Unsafe getUnsafe(){
       try{
          ...
          try{
             return AccessController.doPrivileged(new Striped64$a());
    ...
    public final boolean casBase(long p0,long p1){
       return Striped64.b.compareAndSwapLong(this, Striped64.c, p0, p1);
    }
    public final boolean casBusy(){
       return Striped64.b.compareAndSwapInt(this, Striped64.d, 0, 1);
    }
             ...
             if (len > 0) {
                ...
                if (oobject == null) {
                   if (striped64.busy == null) {
                      Striped64$b uob = new Striped64$b(l);
                   ...
                   if (!oobject.a(h, striped64.fn(h, l))) {
                      if (len >= Striped64.NCPU || striped64.cells != cells) {
                         ...
                         if (striped64.cells == cells) {
                            int i4 = len << 1;
                            Striped64$b[] uobArray = new Striped64$b[i4];
                            for (i2 = 0; i2 < len; i2 = i2 + 1) {
                               uobArray[i2] = cells[i2];
                            }
                            striped64.cells = uobArray;
                         }
                         striped64.busy = 0;
                         striped641 = null;
                      }
                ...
                if (striped64.cells == cells) {
                   Striped64$b[] uobArray1 = new Striped64$b[2];
                   len = i1 & 0x01;
                   uobArray1[len] = new Striped64$b(l);
                   striped64.cells = uobArray1;
                   cells = 1;
                }else {
                   cells = null;
                }
